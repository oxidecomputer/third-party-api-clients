...
pub async fn get(
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, type_: crate::types::CampaignType, status: crate::types::GetCampaignsStatus, before_send_time: Option<chrono::DateTime<chrono::Utc>>, since_send_time: Option<chrono::DateTime<chrono::Utc>>, before_create_time: Option<chrono::DateTime<chrono::Utc>>, since_create_time: Option<chrono::DateTime<chrono::Utc>>, list_id: &str, folder_id: &str, member_id: &str, sort_field: crate::types::SortField, sort_dir: crate::types::SortDir,
) -> Result<crate::types::GetCampaignsResponse> {
let mut query_args: Vec<(String, String)> = Default::default();
if let Some(date) = before_create_time { query_args.push(("before_create_time".to_string(), date.to_rfc3339())); }
...
if !folder_id.is_empty() { query_args.push(("folder_id".to_string(), folder_id.to_string())); }
if !list_id.is_empty() { query_args.push(("list_id".to_string(), list_id.to_string())); }
if !member_id.is_empty() { query_args.push(("member_id".to_string(), member_id.to_string())); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if let Some(date) = since_create_time { query_args.push(("since_create_time".to_string(), date.to_rfc3339())); }
...
let url =
format!("/campaigns/{}/actions/cancel-send",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
let url =
format!("/campaigns/{}/actions/replicate",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
* * `campaign_id: &str` -- The unique id for the campaign.
*/
pub async fn post_actions_send(
&self,
campaign_id: &str,
) -> Result<()> {
let url =
format!("/campaigns/{}/actions/send",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
let url =
format!("/campaigns/{}/actions/schedule",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
let url =
format!("/campaigns/{}/actions/unschedule",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
* * `campaign_id: &str` -- The unique id for the campaign.
*/
pub async fn post_actions_pause(
&self,
campaign_id: &str,
) -> Result<()> {
let url =
format!("/campaigns/{}/actions/pause",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
let url =
format!("/campaigns/{}/actions/resume",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
let url =
format!("/campaigns/{}/actions/create-resend",
crate::progenitor_support::encode_path(&campaign_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, feedback_id: &str,
) -> Result<crate::types::CampaignFeedbackData> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/campaigns/{}/feedback/{}?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&feedback_id.to_string()),query_);
...
&self,
campaign_id: &str, feedback_id: &str,
) -> Result<()> {
let url =
format!("/campaigns/{}/feedback/{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&feedback_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/campaigns/{}/send-checklist?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),query_);
