...
pub async fn get(
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, before_date_created: &str, since_date_created: &str, before_campaign_last_sent: &str, since_campaign_last_sent: &str, email: &str, sort_field: crate::types::GetListsSortField, sort_dir: crate::types::SortDir, has_ecommerce_store: bool, include_total_contacts: bool,
) -> Result<crate::types::SubscriberLists> {
let mut query_args: Vec<(String, String)> = Default::default();
if !before_campaign_last_sent.is_empty() { query_args.push(("before_campaign_last_sent".to_string(), before_campaign_last_sent.to_string())); }
if !before_date_created.is_empty() { query_args.push(("before_date_created".to_string(), before_date_created.to_string())); }
if count > 0 { query_args.push(("count".to_string(), count.to_string())); }
if !email.is_empty() { query_args.push(("email".to_string(), email.to_string())); }
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if has_ecommerce_store { query_args.push(("has_ecommerce_store".to_string(), has_ecommerce_store.to_string())); }
if include_total_contacts { query_args.push(("include_total_contacts".to_string(), include_total_contacts.to_string())); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if !since_campaign_last_sent.is_empty() { query_args.push(("since_campaign_last_sent".to_string(), since_campaign_last_sent.to_string())); }
if !since_date_created.is_empty() { query_args.push(("since_date_created".to_string(), since_date_created.to_string())); }
if !sort_dir.to_string().is_empty() {  query_args.push(("sort_dir".to_string(), sort_dir.to_string())); }
if !sort_field.to_string().is_empty() {  query_args.push(("sort_field".to_string(), sort_field.to_string())); }
...
&self,
fields: &[String], exclude_fields: &[String], list_id: &str, include_total_contacts: bool,
) -> Result<crate::types::Lists> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
&self,
list_id: &str, skip_merge_validation: bool, skip_duplicate_check: bool,
body: &crate::types::MembersSubscribeUnsubscribeFromAListInBatch
) -> Result<crate::types::BatchUpdateListMembers> {
let mut query_args: Vec<(String, String)> = Default::default();
if skip_duplicate_check { query_args.push(("skip_duplicate_check".to_string(), skip_duplicate_check.to_string())); }
if skip_merge_validation { query_args.push(("skip_merge_validation".to_string(), skip_merge_validation.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
self.client.patch(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, list_id: &str,
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, list_id: &str, report_id: &str,
...
let url =
format!("/lists/{}/abuse-reports/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&report_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], list_id: &str,
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, list_id: &str, sort_field: crate::types::GetListsGrowthHistorySortField, sort_dir: crate::types::SortDir,
...
&self,
fields: &[String], exclude_fields: &[String], list_id: &str, month: &str,
...
let url =
format!("/lists/{}/growth-history/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&month.to_string()),query_);
...
&self,
list_id: &str, fields: &[String], exclude_fields: &[String], count: i64, offset: i64, type_: &str,
...
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if !type_.is_empty() { query_args.push(("type".to_string(), type_.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/interest-categories?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
&self,
list_id: &str, interest_category_id: &str, fields: &[String], exclude_fields: &[String],
) -> Result<crate::types::Categories> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}/interest-categories/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&interest_category_id.to_string()),query_);
...
&self,
list_id: &str, interest_category_id: &str,
) -> Result<()> {
let url =
format!("/lists/{}/interest-categories/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&interest_category_id.to_string()),);
...
&self,
list_id: &str, interest_category_id: &str, fields: &[String], exclude_fields: &[String], count: i64, offset: i64,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/interest-categories/{}/interests?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&interest_category_id.to_string()),query_);
...
&self,
list_id: &str, interest_category_id: &str, interest_id: &str, fields: &[String], exclude_fields: &[String],
) -> Result<crate::types::InterestsInterest> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}/interest-categories/{}/interests/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&interest_category_id.to_string()),crate::progenitor_support::encode_path(&interest_id.to_string()),query_);
...
&self,
list_id: &str, interest_category_id: &str, interest_id: &str,
) -> Result<()> {
let url =
format!("/lists/{}/interest-categories/{}/interests/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&interest_category_id.to_string()),crate::progenitor_support::encode_path(&interest_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, list_id: &str, type_: &str, since_created_at: &str, before_created_at: &str, include_cleaned: bool, include_transactional: bool, include_unsubscribed: bool, since_updated_at: &str, before_updated_at: &str,
) -> Result<crate::types::CollectionOfSegments> {
let mut query_args: Vec<(String, String)> = Default::default();
if !before_created_at.is_empty() { query_args.push(("before_created_at".to_string(), before_created_at.to_string())); }
if !before_updated_at.is_empty() { query_args.push(("before_updated_at".to_string(), before_updated_at.to_string())); }
if count > 0 { query_args.push(("count".to_string(), count.to_string())); }
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if include_cleaned { query_args.push(("include_cleaned".to_string(), include_cleaned.to_string())); }
if include_transactional { query_args.push(("include_transactional".to_string(), include_transactional.to_string())); }
if include_unsubscribed { query_args.push(("include_unsubscribed".to_string(), include_unsubscribed.to_string())); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if !since_created_at.is_empty() { query_args.push(("since_created_at".to_string(), since_created_at.to_string())); }
if !since_updated_at.is_empty() { query_args.push(("since_updated_at".to_string(), since_updated_at.to_string())); }
if !type_.is_empty() { query_args.push(("type".to_string(), type_.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/segments?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], list_id: &str, segment_id: &str, include_cleaned: bool, include_transactional: bool, include_unsubscribed: bool,
) -> Result<crate::types::Segments> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}/segments/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&segment_id.to_string()),query_);
...
&self,
list_id: &str, segment_id: &str,
body: &crate::types::MembersAddRemoveFromAStaticSegment
) -> Result<crate::types::BatchAddRemoveListMembersFromStaticSegment> {
let url =
format!("/lists/{}/segments/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&segment_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, list_id: &str, segment_id: &str, include_cleaned: bool, include_transactional: bool, include_unsubscribed: bool,
...
&self,
list_id: &str, segment_id: &str, subscriber_hash: &str,
) -> Result<()> {
let url =
format!("/lists/{}/segments/{}/members/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&segment_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),);
...
&self,
list_id: &str, name: &str,
) -> Result<crate::types::TagSearchResults> {
let mut query_args: Vec<(String, String)> = Default::default();
if !name.is_empty() { query_args.push(("name".to_string(), name.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/tag-search?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, list_id: &str, email_type: &str, status: crate::types::GetListsMembersStatus, since_timestamp_opt: &str, before_timestamp_opt: &str, since_last_changed: &str, before_last_changed: &str, unique_email_id: &str, vip_only: bool, interest_category_id: &str, interest_ids: &str, interest_match: crate::types::InterestMatch, sort_field: crate::types::GetListsMembersSortField, sort_dir: crate::types::SortDir, since_last_campaign: bool, unsubscribed_since: &str,
) -> Result<crate::types::ListMembersDataType> {
let mut query_args: Vec<(String, String)> = Default::default();
if !before_last_changed.is_empty() { query_args.push(("before_last_changed".to_string(), before_last_changed.to_string())); }
if !before_timestamp_opt.is_empty() { query_args.push(("before_timestamp_opt".to_string(), before_timestamp_opt.to_string())); }
if count > 0 { query_args.push(("count".to_string(), count.to_string())); }
if !email_type.is_empty() { query_args.push(("email_type".to_string(), email_type.to_string())); }
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if !interest_category_id.is_empty() { query_args.push(("interest_category_id".to_string(), interest_category_id.to_string())); }
if !interest_ids.is_empty() { query_args.push(("interest_ids".to_string(), interest_ids.to_string())); }
if !interest_match.to_string().is_empty() {  query_args.push(("interest_match".to_string(), interest_match.to_string())); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if since_last_campaign { query_args.push(("since_last_campaign".to_string(), since_last_campaign.to_string())); }
if !since_last_changed.is_empty() { query_args.push(("since_last_changed".to_string(), since_last_changed.to_string())); }
if !since_timestamp_opt.is_empty() { query_args.push(("since_timestamp_opt".to_string(), since_timestamp_opt.to_string())); }
if !sort_dir.to_string().is_empty() {  query_args.push(("sort_dir".to_string(), sort_dir.to_string())); }
if !sort_field.to_string().is_empty() {  query_args.push(("sort_field".to_string(), sort_field.to_string())); }
if !status.to_string().is_empty() {  query_args.push(("status".to_string(), status.to_string())); }
if !unique_email_id.is_empty() { query_args.push(("unique_email_id".to_string(), unique_email_id.to_string())); }
if !unsubscribed_since.is_empty() { query_args.push(("unsubscribed_since".to_string(), unsubscribed_since.to_string())); }
if vip_only { query_args.push(("vip_only".to_string(), vip_only.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/members?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
&self,
list_id: &str, skip_merge_validation: bool,
...
&self,
fields: &[String], exclude_fields: &[String], list_id: &str, subscriber_hash: &str,
) -> Result<crate::types::ListMembersData> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}/members/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),query_);
...
&self,
list_id: &str, subscriber_hash: &str, skip_merge_validation: bool,
...
&self,
list_id: &str, subscriber_hash: &str,
) -> Result<()> {
let url =
format!("/lists/{}/members/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),);
...
&self,
list_id: &str, subscriber_hash: &str, fields: &[String], exclude_fields: &[String], action: &[String],
) -> Result<crate::types::MemberActivityEvents> {
let mut query_args: Vec<(String, String)> = Default::default();
if !action.is_empty() { query_args.push(("action".to_string(), action.join(" "))); }
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/members/{}/activity?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),query_);
...
&self,
list_id: &str, subscriber_hash: &str, fields: &[String], exclude_fields: &[String], count: i64, offset: i64, activity_filters: &[String],
) -> Result<crate::types::MemberActivityEventsData> {
let mut query_args: Vec<(String, String)> = Default::default();
if !activity_filters.is_empty() { query_args.push(("activity_filters".to_string(), activity_filters.join(" "))); }
if count > 0 { query_args.push(("count".to_string(), count.to_string())); }
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/members/{}/activity-feed?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),query_);
...
&self,
list_id: &str, subscriber_hash: &str, fields: &[String], exclude_fields: &[String], count: i64, offset: i64,
...
&self,
list_id: &str, subscriber_hash: &str, count: i64, offset: i64, fields: &[String], exclude_fields: &[String],
...
&self,
list_id: &str, subscriber_hash: &str, fields: &[String], exclude_fields: &[String],
...
&self,
list_id: &str, subscriber_hash: &str, sort_field: crate::types::GetListsMembersNotesSortField, sort_dir: crate::types::SortDir, fields: &[String], exclude_fields: &[String], count: i64, offset: i64,
...
&self,
list_id: &str, subscriber_hash: &str, note_id: &str, fields: &[String], exclude_fields: &[String],
) -> Result<crate::types::CollectionOfNotesMember> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}/members/{}/notes/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),crate::progenitor_support::encode_path(&note_id.to_string()),query_);
...
&self,
list_id: &str, subscriber_hash: &str, note_id: &str,
) -> Result<()> {
let url =
format!("/lists/{}/members/{}/notes/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),crate::progenitor_support::encode_path(&note_id.to_string()),);
...
let url =
format!("/lists/{}/members/{}/actions/delete-permanent",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),);
...
&self,
list_id: &str, fields: &[String], exclude_fields: &[String], count: i64, offset: i64, type_: &str, required: bool,
...
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if required { query_args.push(("required".to_string(), required.to_string())); }
if !type_.is_empty() { query_args.push(("type".to_string(), type_.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/lists/{}/merge-fields?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),query_);
...
&self,
list_id: &str, merge_id: &str, exclude_fields: &[String], fields: &[String],
) -> Result<crate::types::MergeField> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/lists/{}/merge-fields/{}?{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&merge_id.to_string()),query_);
...
&self,
list_id: &str, merge_id: &str,
) -> Result<()> {
let url =
format!("/lists/{}/merge-fields/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&merge_id.to_string()),);
...
&self,
list_id: &str,
) -> Result<crate::types::ListWebhooksData> {
let url =
format!("/lists/{}/webhooks",
crate::progenitor_support::encode_path(&list_id.to_string()),);
...
&self,
list_id: &str, webhook_id: &str,
) -> Result<crate::types::ListWebhooks> {
let url =
format!("/lists/{}/webhooks/{}",
crate::progenitor_support::encode_path(&list_id.to_string()),crate::progenitor_support::encode_path(&webhook_id.to_string()),);
...
&self,
list_id: &str,
) -> Result<crate::types::ListSignupForms> {
let url =
format!("/lists/{}/signup-forms",
crate::progenitor_support::encode_path(&list_id.to_string()),);
