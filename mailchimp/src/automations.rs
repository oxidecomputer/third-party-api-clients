...
pub async fn get(
&self,
count: i64, offset: i64, fields: &[String], exclude_fields: &[String], before_create_time: Option<chrono::DateTime<chrono::Utc>>, since_create_time: Option<chrono::DateTime<chrono::Utc>>, before_start_time: Option<chrono::DateTime<chrono::Utc>>, since_start_time: Option<chrono::DateTime<chrono::Utc>>, status: crate::types::Status,
...
if let Some(date) = before_start_time { query_args.push(("before_start_time".to_string(), date.to_rfc3339())); }
...
if let Some(date) = since_start_time { query_args.push(("since_start_time".to_string(), date.to_rfc3339())); }
...
&self,
fields: &[String], exclude_fields: &[String], workflow_id: &str,
) -> Result<crate::types::Automations> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/automations/{}?{}",
crate::progenitor_support::encode_path(&workflow_id.to_string()),query_);
...
let url =
format!("/automations/{}/actions/pause-all-emails",
...
let url =
format!("/automations/{}/actions/start-all-emails",
crate::progenitor_support::encode_path(&workflow_id.to_string()),);
...
let url =
format!("/automations/{}/actions/archive",
crate::progenitor_support::encode_path(&workflow_id.to_string()),);
...
&self,
workflow_id: &str,
) -> Result<crate::types::AutomationEmails> {
let url =
format!("/automations/{}/emails",
crate::progenitor_support::encode_path(&workflow_id.to_string()),);
...
&self,
workflow_id: &str, workflow_email_id: &str,
) -> Result<crate::types::Emails> {
let url =
format!("/automations/{}/emails/{}",
crate::progenitor_support::encode_path(&workflow_id.to_string()),crate::progenitor_support::encode_path(&workflow_email_id.to_string()),);
...
let url =
format!("/automations/{}/emails/{}/queue",
crate::progenitor_support::encode_path(&workflow_id.to_string()),crate::progenitor_support::encode_path(&workflow_email_id.to_string()),);
...
&self,
workflow_id: &str, workflow_email_id: &str, subscriber_hash: &str,
) -> Result<crate::types::SubscriberInAutomationQueueData> {
let url =
format!("/automations/{}/emails/{}/queue/{}",
crate::progenitor_support::encode_path(&workflow_id.to_string()),crate::progenitor_support::encode_path(&workflow_email_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),);
...
let url =
format!("/automations/{}/emails/{}/actions/pause",
crate::progenitor_support::encode_path(&workflow_id.to_string()),crate::progenitor_support::encode_path(&workflow_email_id.to_string()),);
...
let url =
format!("/automations/{}/emails/{}/actions/start",
crate::progenitor_support::encode_path(&workflow_id.to_string()),crate::progenitor_support::encode_path(&workflow_email_id.to_string()),);
...
let url =
format!("/automations/{}/removed-subscribers",
crate::progenitor_support::encode_path(&workflow_id.to_string()),);
...
&self,
workflow_id: &str, subscriber_hash: &str,
) -> Result<crate::types::Subscribers> {
let url =
format!("/automations/{}/removed-subscribers/{}",
crate::progenitor_support::encode_path(&workflow_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),);
