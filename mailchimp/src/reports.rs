...
pub async fn get(
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, type_: crate::types::CampaignType, before_send_time: Option<chrono::DateTime<chrono::Utc>>, since_send_time: Option<chrono::DateTime<chrono::Utc>>,
) -> Result<crate::types::CampaignReportsData> {
let mut query_args: Vec<(String, String)> = Default::default();
if let Some(date) = before_send_time { query_args.push(("before_send_time".to_string(), date.to_rfc3339())); }
...
if let Some(date) = since_send_time { query_args.push(("since_send_time".to_string(), date.to_rfc3339())); }
if !type_.to_string().is_empty() {  query_args.push(("type".to_string(), type_.to_string())); }
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str,
...
let url =
format!("/reports/{}?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, report_id: &str,
...
let url =
format!("/reports/{}/abuse-reports/{}?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&report_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, campaign_id: &str,
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, link_id: &str,
...
let url =
format!("/reports/{}/click-details/{}?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&link_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, campaign_id: &str, link_id: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/reports/{}/click-details/{}/members?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&link_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, link_id: &str, subscriber_hash: &str,
...
let url =
format!("/reports/{}/click-details/{}/members/{}?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&link_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, campaign_id: &str, since: &str,
...
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if !since.is_empty() { query_args.push(("since".to_string(), since.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/reports/{}/open-details?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, subscriber_hash: &str,
...
let url =
format!("/reports/{}/open-details/{}?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),crate::progenitor_support::encode_path(&subscriber_hash.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/reports/{}/domain-performance?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, subscriber_hash: &str, since: &str,
...
&self,
fields: &[String], exclude_fields: &[String], campaign_id: &str, count: i64, offset: i64,
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, campaign_id: &str, sort_field: crate::types::GetReportsEcommerceProductActivitySortField,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/reports/{}/ecommerce-product-activity?{}",
crate::progenitor_support::encode_path(&campaign_id.to_string()),query_);
