...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, campaign_id: &str, outreach_id: &str, customer_id: &str, has_outreach: bool,
) -> Result<crate::types::OrdersData> {
let mut query_args: Vec<(String, String)> = Default::default();
if !campaign_id.is_empty() { query_args.push(("campaign_id".to_string(), campaign_id.to_string())); }
if count > 0 { query_args.push(("count".to_string(), count.to_string())); }
if !customer_id.is_empty() { query_args.push(("customer_id".to_string(), customer_id.to_string())); }
...
if has_outreach { query_args.push(("has_outreach".to_string(), has_outreach.to_string())); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
if !outreach_id.is_empty() { query_args.push(("outreach_id".to_string(), outreach_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/orders?{}",
query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64,
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str,
) -> Result<crate::types::Stores> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, store_id: &str,
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, cart_id: &str,
) -> Result<crate::types::Carts> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/carts/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&cart_id.to_string()),query_);
...
&self,
store_id: &str, cart_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/carts/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&cart_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, store_id: &str, cart_id: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/carts/{}/lines?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&cart_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, cart_id: &str, line_id: &str,
) -> Result<crate::types::ECommerceCartLineItem> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/carts/{}/lines/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&cart_id.to_string()),crate::progenitor_support::encode_path(&line_id.to_string()),query_);
...
&self,
store_id: &str, cart_id: &str, line_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/carts/{}/lines/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&cart_id.to_string()),crate::progenitor_support::encode_path(&line_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, store_id: &str, email_address: &str,
) -> Result<crate::types::Customers> {
let mut query_args: Vec<(String, String)> = Default::default();
if count > 0 { query_args.push(("count".to_string(), count.to_string())); }
if !email_address.is_empty() { query_args.push(("email_address".to_string(), email_address.to_string())); }
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
if offset > 0 { query_args.push(("offset".to_string(), offset.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/customers?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, customer_id: &str,
) -> Result<crate::types::Customer> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/customers/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&customer_id.to_string()),query_);
...
let url =
format!("/ecommerce/stores/{}/customers/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&customer_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/promo-rules?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, promo_rule_id: &str,
) -> Result<crate::types::PromoRules> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/promo-rules/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&promo_rule_id.to_string()),query_);
...
&self,
store_id: &str, promo_rule_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/promo-rules/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&promo_rule_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, promo_rule_id: &str, store_id: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/promo-rules/{}/promo-codes?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&promo_rule_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, promo_rule_id: &str, promo_code_id: &str,
) -> Result<crate::types::PromoCodes> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/promo-rules/{}/promo-codes/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&promo_rule_id.to_string()),crate::progenitor_support::encode_path(&promo_code_id.to_string()),query_);
...
&self,
store_id: &str, promo_rule_id: &str, promo_code_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/promo-rules/{}/promo-codes/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&promo_rule_id.to_string()),crate::progenitor_support::encode_path(&promo_code_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, store_id: &str, customer_id: &str, has_outreach: bool, campaign_id: &str, outreach_id: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/orders?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, order_id: &str,
) -> Result<crate::types::Orders> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/orders/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
&self,
store_id: &str, order_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/orders/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&order_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, store_id: &str, order_id: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/orders/{}/lines?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, order_id: &str, line_id: &str,
) -> Result<crate::types::Lines> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/orders/{}/lines/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&order_id.to_string()),crate::progenitor_support::encode_path(&line_id.to_string()),query_);
...
&self,
store_id: &str, order_id: &str, line_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/orders/{}/lines/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&order_id.to_string()),crate::progenitor_support::encode_path(&line_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/products?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, product_id: &str,
) -> Result<crate::types::ECommerceProduct> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/products/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let url =
format!("/ecommerce/stores/{}/products/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, store_id: &str, product_id: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/products/{}/variants?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, product_id: &str, variant_id: &str,
) -> Result<crate::types::Variants> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/products/{}/variants/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),crate::progenitor_support::encode_path(&variant_id.to_string()),query_);
...
&self,
store_id: &str, product_id: &str, variant_id: &str,
body: &crate::types::ECommerceProductVariant
) -> Result<crate::types::Variants> {
let url =
format!("/ecommerce/stores/{}/products/{}/variants/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),crate::progenitor_support::encode_path(&variant_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/ecommerce/stores/{}/products/{}/images?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], store_id: &str, product_id: &str, image_id: &str,
) -> Result<crate::types::Images> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_fields.is_empty() { query_args.push(("exclude_fields".to_string(), exclude_fields.join(" "))); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.join(" "))); }
...
let url =
format!("/ecommerce/stores/{}/products/{}/images/{}?{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),crate::progenitor_support::encode_path(&image_id.to_string()),query_);
...
&self,
store_id: &str, product_id: &str, image_id: &str,
) -> Result<()> {
let url =
format!("/ecommerce/stores/{}/products/{}/images/{}",
crate::progenitor_support::encode_path(&store_id.to_string()),crate::progenitor_support::encode_path(&product_id.to_string()),crate::progenitor_support::encode_path(&image_id.to_string()),);
