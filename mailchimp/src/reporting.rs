...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, sort_field: crate::types::GetAllFacebookAdsSortField, sort_dir: crate::types::SortDir,
...
&self,
fields: &[String], outreach_id: &str, exclude_fields: &[String],
...
let url =
format!("/reporting/facebook-ads/{}?{}",
crate::progenitor_support::encode_path(&outreach_id.to_string()),query_);
...
&self,
fields: &[String], exclude_fields: &[String], count: i64, offset: i64, outreach_id: &str, sort_field: crate::types::GetReportsEcommerceProductActivitySortField,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/reporting/facebook-ads/{}/ecommerce-product-activity?{}",
crate::progenitor_support::encode_path(&outreach_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/reporting/landing-pages/{}?{}",
crate::progenitor_support::encode_path(&outreach_id.to_string()),query_);
