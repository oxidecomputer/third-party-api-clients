...
&self,
journey_id: i64, step_id: i64,
body: &crate::types::SubscriberInAutomationQueue
) -> Result<()> {
let url =
format!("/customer-journeys/journeys/{}/steps/{}/actions/trigger",
crate::progenitor_support::encode_path(&journey_id.to_string()),crate::progenitor_support::encode_path(&step_id.to_string()),);
