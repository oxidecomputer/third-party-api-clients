...
*/
#[serde(default,
skip_serializing_if = "Type::is_noop",
rename = "type")]
pub type_: Type,
}
...
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
GetActivityFeedChimpChatterResponseType::CampaignsFacebookLikes => "campaigns:facebook-likes",
GetActivityFeedChimpChatterResponseType::CampaignsForwardToFriend => "campaigns:forward-to-friend",
...
*/
#[serde(default,
skip_serializing_if = "SegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "PollActivitySegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "PollActivitySegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "ConversationSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "DateSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "DateSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "EmailClientSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "EmailClientSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "LanguageSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "LanguageSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "MemberRatingSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "MemberRatingSegmentOperator::is_noop",
)]
...
#[serde(default,
skip_serializing_if = "SignupSourceSegmentType::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "SignupSourceSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "SurveyMonkeySegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "VipSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "EcommerceNumberSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "GoalActivitySegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "GoalActivitySegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "GoalTimestampSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "GoalTimestampSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "StaticSegmentMemberField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "StaticSegmentMemberOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "LocationBasedSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "LocationBasedSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "GeolocationSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "UsZipCodeSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "Value::is_noop",
)]
pub value: Value,
}
...
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
SocialProfilesNetworkFollowSegmentConditionType::SocialNetworkFollow => "SocialNetworkFollow",
...
*/
#[serde(default,
skip_serializing_if = "EmailSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "EmailSegmentOperator::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "PredictedGenderSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "PredictedAgeSegmentField::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "PredictedAgeSegmentOperator::is_noop",
)]
...
pub fn social_profiles_network_follow_segment(&self) -> Option<&SocialProfilesNetworkFollowSegment> {
...
*/
#[serde(default,
skip_serializing_if = "WorkflowType::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "DelayAction::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "HttpMethod::is_noop",
)]
...
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone, JsonSchema)]
pub struct CampaignsResultsCampaignSettings {
/**
* The settings for your campaign, including subject, from name, reply-to address, and more.
*/
#[serde(default,
...
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone, JsonSchema)]
pub struct CampaignsResultsCampaignReportSummary {
/**
* For sent campaigns, a summary of opens, clicks, and e-commerce data.
*/
#[serde(default,
...
pub report_summary: Option<CampaignsResultsCampaignReportSummary>,
/**
* A summary of an individual campaign's settings and content.
*/
#[serde(default,
...
pub settings: Option<CampaignsResultsCampaignSettings>,
/**
* A summary of an individual campaign's settings and content.
*/
#[serde(default,
...
*/
#[serde(default,
skip_serializing_if = "WinnerCriteria::is_noop",
)]
...
*/
#[serde(default,
skip_serializing_if = "Frequency::is_noop",
)]
...
/// List settings for the campaign.
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone, JsonSchema)]
pub struct CampaignListDataType {
/**
* The name of the folder.
*/
#[serde(default,
...
pub recipients: Option<CampaignListDataType>,
/**
* A summary of an individual campaign's settings and content.
*/
#[serde(default,
...
*/
#[serde(default,
skip_serializing_if = "SendType::is_noop",
)]
...
impl MembersSubscribeUnsubscribeFromAListInBatchStatus {
            pub fn is_noop(&self) -> bool {
                matches!(self, MembersSubscribeUnsubscribeFromAListInBatchStatus::Noop)
            }
    }
...
*/
#[serde(default,
skip_serializing_if = "MemberTagsTagStatus::is_noop",
)]
...
pub opens: Vec<OpenActivityMember>,
/**
* A list of a member's opens activity in a specific campaign.
*/
#[serde(default,
