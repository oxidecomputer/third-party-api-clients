...
pub async fn code(
&self,
q: &str, sort: crate::types::SearchCodeSort, order: crate::types::Order, per_page: i64, page: i64,
...
&self,
q: &str, sort: crate::types::SearchCommitsSort, order: crate::types::Order, per_page: i64, page: i64,
...
&self,
q: &str, sort: crate::types::SearchIssuesPullRequestsSort, order: crate::types::Order, per_page: i64, page: i64,
...
pub async fn labels(
&self,
repository_id: i64, q: &str, sort: crate::types::Sort, order: crate::types::Order, per_page: i64, page: i64,
...
if per_page > 0 { query_args.push(format!("per_page={}", per_page)); }
if !q.is_empty() { query_args.push(format!("q={}", q)); }
if repository_id > 0 { query_args.push(format!("repository_id={}", repository_id)); }
query_args.push(format!("sort={}", sort));
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
...
pub async fn repos(
&self,
q: &str, sort: crate::types::SearchReposSort, order: crate::types::Order, per_page: i64, page: i64,
...
pub async fn users(
&self,
q: &str, sort: crate::types::SearchUsersSort, order: crate::types::Order, per_page: i64, page: i64,
