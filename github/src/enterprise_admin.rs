...
let url =
format!("/enterprises/{}/actions/permissions",
...
&self,
enterprise: &str, per_page: i64, page: i64,
...
let url =
format!("/enterprises/{}/actions/permissions/organizations?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),query);
...
&self,
enterprise: &str, org_id: i64,
) -> Result<()> {
let url =
format!("/enterprises/{}/actions/permissions/organizations/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&org_id.to_string()),);
...
let url =
format!("/enterprises/{}/actions/permissions/selected-actions",
crate::progenitor_support::encode_path(&enterprise.to_string()),);
...
let url =
format!("/enterprises/{}/actions/runner-groups?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),query);
...
&self,
enterprise: &str, runner_group_id: i64,
) -> Result<crate::types::RunnerGroupsEnterprise> {
let url =
format!("/enterprises/{}/actions/runner-groups/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&runner_group_id.to_string()),);
...
&self,
enterprise: &str, runner_group_id: i64, per_page: i64, page: i64,
) -> Result<crate::types::EnterpriseAdminListOrgAccessSelfHostedRunnerGroupInResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if page > 0 { query_args.push(format!("page={}", page)); }
...
let url =
format!("/enterprises/{}/actions/runner-groups/{}/organizations?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&runner_group_id.to_string()),query);
...
&self,
enterprise: &str, runner_group_id: i64, org_id: i64,
) -> Result<()> {
let url =
format!("/enterprises/{}/actions/runner-groups/{}/organizations/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&runner_group_id.to_string()),crate::progenitor_support::encode_path(&org_id.to_string()),);
...
let url =
format!("/enterprises/{}/actions/runner-groups/{}/runners?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&runner_group_id.to_string()),query);
...
&self,
enterprise: &str, runner_group_id: i64, runner_id: i64,
) -> Result<()> {
let url =
format!("/enterprises/{}/actions/runner-groups/{}/runners/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&runner_group_id.to_string()),crate::progenitor_support::encode_path(&runner_id.to_string()),);
...
let url =
format!("/enterprises/{}/actions/runners?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),query);
...
let url =
format!("/enterprises/{}/actions/runners/downloads",
crate::progenitor_support::encode_path(&enterprise.to_string()),);
...
let url =
format!("/enterprises/{}/actions/runners/registration-token",
crate::progenitor_support::encode_path(&enterprise.to_string()),);
...
let url =
format!("/enterprises/{}/actions/runners/remove-token",
crate::progenitor_support::encode_path(&enterprise.to_string()),);
...
&self,
enterprise: &str, runner_id: i64,
) -> Result<crate::types::Runner> {
let url =
format!("/enterprises/{}/actions/runners/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&runner_id.to_string()),);
...
&self,
enterprise: &str, phrase: &str, include: crate::types::Include, after: &str, before: &str, order: crate::types::Order, page: i64, per_page: i64,
) -> Result<Vec<crate::types::AuditLogEvent>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !after.is_empty() { query_args.push(format!("after={}", after)); }
if !before.is_empty() { query_args.push(format!("before={}", before)); }
query_args.push(format!("include={}", include));
query_args.push(format!("order={}", order));
if page > 0 { query_args.push(format!("page={}", page)); }
if per_page > 0 { query_args.push(format!("per_page={}", per_page)); }
if !phrase.is_empty() { query_args.push(format!("phrase={}", phrase)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
&self,
enterprise: &str, phrase: &str, include: crate::types::Include, after: &str, before: &str, order: crate::types::Order,
) -> Result<Vec<crate::types::AuditLogEvent>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !after.is_empty() { query_args.push(format!("after={}", after)); }
...
&self,
enterprise: &str, start_index: i64, count: i64, filter: &str, excluded_attributes: &str,
) -> Result<crate::types::ScimGroupListEnterprise> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if count > 0 { query_args.push(format!("count={}", count)); }
if !excluded_attributes.is_empty() { query_args.push(format!("excluded_attributes={}", excluded_attributes)); }
if !filter.is_empty() { query_args.push(format!("filter={}", filter)); }
if start_index > 0 { query_args.push(format!("start_index={}", start_index)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
let url =
format!("/scim/v2/enterprises/{}/Groups?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),query);
...
&self,
enterprise: &str, scim_group_id: &str, excluded_attributes: &str,
) -> Result<crate::types::ScimEnterpriseGroup> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !excluded_attributes.is_empty() { query_args.push(format!("excluded_attributes={}", excluded_attributes)); }
...
let url =
format!("/scim/v2/enterprises/{}/Groups/{}?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&scim_group_id.to_string()),query);
...
&self,
enterprise: &str, scim_group_id: &str,
body: &crate::types::EnterpriseAdminProvisionInviteGroupRequest
) -> Result<crate::types::ScimEnterpriseGroup> {
let url =
format!("/scim/v2/enterprises/{}/Groups/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&scim_group_id.to_string()),);
...
&self,
enterprise: &str, start_index: i64, count: i64, filter: &str,
...
let url =
format!("/scim/v2/enterprises/{}/Users?{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),query);
...
&self,
enterprise: &str, scim_user_id: &str,
) -> Result<crate::types::ScimEnterpriseUser> {
let url =
format!("/scim/v2/enterprises/{}/Users/{}",
crate::progenitor_support::encode_path(&enterprise.to_string()),crate::progenitor_support::encode_path(&scim_user_id.to_string()),);
