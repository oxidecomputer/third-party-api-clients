...
impl EnterpriseAdmin {
    ...
    pub async fn list_selected_organizations_enabled_github_actions_enterprise(
        ...
        per_page: i64,
        page: i64,
    ) -> Result<crate::types::GetEnterpriseAdminListOrgAccessSelfHostedRunnerGroupInOkResponse>
    {
        let url = format!(
    ...
    pub async fn list_self_hosted_runner_groups_for_enterprise(
        ...
        per_page: i64,
        page: i64,
    ) -> Result<crate::types::GetEnterpriseAdminListSelfHostedRunnerGroupsOkResponse> {
        let url = format!(
    ...
    pub async fn list_self_hosted_runners_for_enterprise(
        ...
        per_page: i64,
        page: i64,
    ) -> Result<crate::types::GetEnterpriseAdminListSelfHostedRunnersOkResponse> {
        let url = format!(
