...
&self,
org: &str, per_page: i64, page: &str,
) -> Result<crate::types::GroupMapping> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !page.is_empty() { query_args.push(format!("page={}", page)); }
...
&self,
org: &str, team_slug: &str,
) -> Result<crate::types::FullTeam> {
let url =
format!("/orgs/{}/teams/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),);
...
&self,
org: &str, team_slug: &str, direction: crate::types::Direction, per_page: i64, page: i64, pinned: &str,
...
if page > 0 { query_args.push(format!("page={}", page)); }
if per_page > 0 { query_args.push(format!("per_page={}", per_page)); }
if !pinned.is_empty() { query_args.push(format!("pinned={}", pinned)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
let url =
format!("/orgs/{}/teams/{}/discussions?{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),query);
...
&self,
org: &str, team_slug: &str, direction: crate::types::Direction, pinned: &str,
) -> Result<Vec<crate::types::TeamDiscussion>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("direction={}", direction));
...
&self,
org: &str, team_slug: &str, discussion_number: i64,
) -> Result<crate::types::TeamDiscussion> {
let url =
format!("/orgs/{}/teams/{}/discussions/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),crate::progenitor_support::encode_path(&discussion_number.to_string()),);
...
&self,
org: &str, team_slug: &str, discussion_number: i64, direction: crate::types::Direction, per_page: i64, page: i64,
...
let url =
format!("/orgs/{}/teams/{}/discussions/{}/comments?{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),crate::progenitor_support::encode_path(&discussion_number.to_string()),query);
...
&self,
org: &str, team_slug: &str, discussion_number: i64, direction: crate::types::Direction,
) -> Result<Vec<crate::types::TeamDiscussionComment>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("direction={}", direction));
...
&self,
org: &str, team_slug: &str, discussion_number: i64, comment_number: i64,
) -> Result<crate::types::TeamDiscussionComment> {
let url =
format!("/orgs/{}/teams/{}/discussions/{}/comments/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),crate::progenitor_support::encode_path(&discussion_number.to_string()),crate::progenitor_support::encode_path(&comment_number.to_string()),);
...
&self,
org: &str, team_slug: &str, per_page: i64, page: i64,
...
&self,
org: &str, team_slug: &str, role: crate::types::TeamsListMembersInOrgRole, per_page: i64, page: i64,
...
&self,
org: &str, team_slug: &str, role: crate::types::TeamsListMembersInOrgRole,
) -> Result<Vec<crate::types::SimpleUser>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("role={}", role));
...
let url =
format!("/orgs/{}/teams/{}/memberships/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),crate::progenitor_support::encode_path(&username.to_string()),);
...
&self,
org: &str, team_slug: &str, project_id: i64,
) -> Result<crate::types::TeamProject> {
let url =
format!("/orgs/{}/teams/{}/projects/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),crate::progenitor_support::encode_path(&project_id.to_string()),);
...
let url =
format!("/orgs/{}/teams/{}/repos/{}/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),crate::progenitor_support::encode_path(&owner.to_string()),crate::progenitor_support::encode_path(&repo.to_string()),);
...
let url =
format!("/orgs/{}/teams/{}/team-sync/group-mappings",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&team_slug.to_string()),);
...
&self,
team_id: i64, direction: crate::types::Direction, per_page: i64, page: i64,
) -> Result<Vec<crate::types::TeamDiscussion>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("direction={}", direction));
...
crate::progenitor_support::encode_path(&team_id.to_string()),query);
...
&self,
team_id: i64, direction: crate::types::Direction,
) -> Result<Vec<crate::types::TeamDiscussion>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("direction={}", direction));
...
&self,
team_id: i64, discussion_number: i64,
) -> Result<crate::types::TeamDiscussion> {
let url =
format!("/teams/{}/discussions/{}",
crate::progenitor_support::encode_path(&team_id.to_string()),crate::progenitor_support::encode_path(&discussion_number.to_string()),);
...
&self,
team_id: i64, discussion_number: i64, direction: crate::types::Direction, per_page: i64, page: i64,
) -> Result<Vec<crate::types::TeamDiscussionComment>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("direction={}", direction));
...
let url =
format!("/teams/{}/discussions/{}/comments?{}",
crate::progenitor_support::encode_path(&team_id.to_string()),crate::progenitor_support::encode_path(&discussion_number.to_string()),query);
...
&self,
team_id: i64, discussion_number: i64, direction: crate::types::Direction,
) -> Result<Vec<crate::types::TeamDiscussionComment>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("direction={}", direction));
...
&self,
team_id: i64, discussion_number: i64, comment_number: i64,
) -> Result<crate::types::TeamDiscussionComment> {
let url =
format!("/teams/{}/discussions/{}/comments/{}",
crate::progenitor_support::encode_path(&team_id.to_string()),crate::progenitor_support::encode_path(&discussion_number.to_string()),crate::progenitor_support::encode_path(&comment_number.to_string()),);
...
&self,
team_id: i64, per_page: i64, page: i64,
) -> Result<Vec<crate::types::OrganizationInvitation>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if page > 0 { query_args.push(format!("page={}", page)); }
...
&self,
team_id: i64, role: crate::types::TeamsListMembersInOrgRole, per_page: i64, page: i64,
) -> Result<Vec<crate::types::SimpleUser>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if page > 0 { query_args.push(format!("page={}", page)); }
...
&self,
team_id: i64, role: crate::types::TeamsListMembersInOrgRole,
) -> Result<Vec<crate::types::SimpleUser>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("role={}", role));
...
&self,
team_id: i64, username: &str,
) -> Result<()> {
let url =
format!("/teams/{}/members/{}",
crate::progenitor_support::encode_path(&team_id.to_string()),crate::progenitor_support::encode_path(&username.to_string()),);
...
&self,
team_id: i64, project_id: i64,
) -> Result<crate::types::TeamProject> {
let url =
format!("/teams/{}/projects/{}",
crate::progenitor_support::encode_path(&team_id.to_string()),crate::progenitor_support::encode_path(&project_id.to_string()),);
...
&self,
team_id: i64, owner: &str, repo: &str,
) -> Result<crate::types::TeamRepository> {
let url =
format!("/teams/{}/repos/{}/{}",
crate::progenitor_support::encode_path(&team_id.to_string()),crate::progenitor_support::encode_path(&owner.to_string()),crate::progenitor_support::encode_path(&repo.to_string()),);
...
let url =
format!("/teams/{}/team-sync/group-mappings",
crate::progenitor_support::encode_path(&team_id.to_string()),);
