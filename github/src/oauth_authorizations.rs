...
&self,
per_page: i64, page: i64, client_id: &str,
) -> Result<Vec<crate::types::ApplicationGrant>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !client_id.is_empty() { query_args.push(format!("client_id={}", client_id)); }
...
&self,
grant_id: i64,
) -> Result<crate::types::ApplicationGrant> {
let url =
format!("/applications/grants/{}",
...
let url =
format!("/authorizations/clients/{}/{}",
crate::progenitor_support::encode_path(&client_id.to_string()),crate::progenitor_support::encode_path(&fingerprint.to_string()),);
