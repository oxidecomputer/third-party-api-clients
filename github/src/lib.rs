...
//! [Client#host](https://docs.rs/octorust/0.1.5/octorust/struct.Client.html#method.host) method.
//!
//! ## Feature flags
//!
//! ### httpcache
...
//! ```toml
//! [dependencies]
//! octorust = { version = "0.1.5", features = ["httpcache"] }
//! ```
//!
...
pub mod gitignore;
#[cfg(feature = "httpcache")]
#[cfg_attr(doc_cfg, doc(cfg(feature = "httpcache")))]
pub mod http_cache;
