...
&self,
org: &str, start_index: i64, count: i64, filter: &str,
...
let url =
format!("/scim/v2/organizations/{}/Users?{}",
...
&self,
org: &str, scim_user_id: &str,
) -> Result<crate::types::ScimUser> {
let url =
format!("/scim/v2/organizations/{}/Users/{}",
crate::progenitor_support::encode_path(&org.to_string()),crate::progenitor_support::encode_path(&scim_user_id.to_string()),);
