...
impl Gitignore {
     ...
     *
     * FROM: <https://docs.github.com/rest/gitignore/gitignore#get-all-gitignore-templates>
     */
     ...
     *
     * FROM: <https://docs.github.com/rest/gitignore/gitignore#get-a-gitignore-template>
     *
     * **Parameters:**
     *
     * * `name: &str`
