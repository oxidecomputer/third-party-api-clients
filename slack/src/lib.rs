...
pub fn admin_conversations_restrict_access(&self) -> admin_conversations_restrict_access::AdminConversationsRestrictAccess {
...
pub fn admin_invite_requests_approved(&self) -> admin_invite_requests_approved::AdminInviteRequestsApproved {
                    admin_invite_requests_approved::AdminInviteRequestsApproved::new(self.clone())
               }

pub fn admin_invite_requests_denied(&self) -> admin_invite_requests_denied::AdminInviteRequestsDenied {
...
pub fn apps_permissions_resources(&self) -> apps_permissions_resources::AppsPermissionsResources {
