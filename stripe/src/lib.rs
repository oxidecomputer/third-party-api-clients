...
{
    let client_id = env::var("STRIPE_CLIENT_ID").expect("must set STRIPE_CLIENT_ID");
    let client_secret = env::var("STRIPE_CLIENT_SECRET").expect("must set STRIPE_CLIENT_SECRET");
    let redirect_uri = env::var("STRIPE_REDIRECT_URI").expect("must set STRIPE_REDIRECT_URI");
