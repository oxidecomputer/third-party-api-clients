...
pub async fn (
&self,
user_id: &str, page_size: i64, page_number: i64,
) -> Result<crate::types::WebinarList> {
...
* * `show_previous_occurrences: bool` -- Set the value of this field to `true` if you would like to view Webinar details of all previous occurrences of a recurring Webinar.
*/
pub async fn webinar(
&self,
webinar_id: i64, occurrence_id: &str, show_previous_occurrences: bool,
) -> Result<crate::types::WebinarResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !occurrence_id.is_empty() { query_args.push(format!("occurrence_id={}", occurrence_id)); }
if show_previous_occurrences { query_args.push(format!("show_previous_occurrences={}", show_previous_occurrences)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
&self,
webinar_id: i64, occurrence_id: &str, cancel_webinar_reminder: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !cancel_webinar_reminder.is_empty() { query_args.push(format!("cancel_webinar_reminder={}", cancel_webinar_reminder)); }
if !occurrence_id.is_empty() { query_args.push(format!("occurrence_id={}", occurrence_id)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
...
*/
pub async fn webinar_update(
&self,
webinar_id: i64, occurrence_id: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !occurrence_id.is_empty() { query_args.push(format!("occurrence_id={}", occurrence_id)); }
...
&self,
webinar_id: &str, webinar_id: &str, page_size: i64, next_page_token: &str,
...
let url =
format!("/past_webinars/{}/participants?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),query);
...
* * `webinar_id: i64` -- The webinar ID in "\*\*long\*\*" format(represented as int64 data type in JSON).
*/
pub async fn webinar_panelist(
&self,
webinar_id: i64,
) -> Result<crate::types::WebinarPanelistList> {
let url =
format!("/webinars/{}/panelists",
crate::progenitor_support::encode_path(&webinar_id.to_string()),);
...
* * `webinar_id: i64` -- The webinar ID in "\*\*long\*\*" format(represented as int64 data type in JSON).
*/
pub async fn webinar_panelists_delete(
&self,
webinar_id: i64,
) -> Result<()> {
let url =
...
*/
pub async fn webinar_panelist_delete(
&self,
webinar_id: i64, panelist_id: i64,
) -> Result<()> {
let url =
format!("/webinars/{}/panelists/{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),crate::progenitor_support::encode_path(&panelist_id.to_string()),);
...
&self,
webinar_id: &str, webinar_id: i64, occurrence_id: &str, status: crate::types::RegistrantStatusData, tracking_source_id: &str, page_size: i64, page_number: i64, next_page_token: &str,
...
if !tracking_source_id.is_empty() { query_args.push(format!("tracking_source_id={}", tracking_source_id)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
&self,
webinar_id: &str, webinar_id: i64, occurrence_ids: &str,
) -> Result<crate::types::WebinarRegistrantCreateResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !occurrence_ids.is_empty() { query_args.push(format!("occurrence_ids={}", occurrence_ids)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
&self,
webinar_id: i64, occurrence_id: &str,
body: &crate::types::WebinarRegistrantStatusRequest
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !occurrence_id.is_empty() { query_args.push(format!("occurrence_id={}", occurrence_id)); }
...
let url =
format!("/webinars/{}/registrants/status?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),query);
...
* * `webinar_id: i64` -- The webinar ID in "\*\*long\*\*" format(represented as int64 data type in JSON).
*/
pub async fn past_webinar(
&self,
webinar_id: i64,
) -> Result<crate::types::WebinarList> {
let url =
format!("/past_webinars/{}/instances",
crate::progenitor_support::encode_path(&webinar_id.to_string()),);
...
* * `webinar_id: i64` -- The webinar ID in "\*\*long\*\*" format(represented as int64 data type in JSON).
*/
pub async fn webinar_poll(
&self,
webinar_id: i64,
) -> Result<crate::types::PollList> {
let url =
format!("/webinars/{}/polls",
crate::progenitor_support::encode_path(&webinar_id.to_string()),);
...
&self,
webinar_id: i64, poll_id: &str,
) -> Result<crate::types::WebinarPollGetResponse> {
let url =
format!("/webinars/{}/polls/{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),crate::progenitor_support::encode_path(&poll_id.to_string()),);
...
* * `poll_id: &str` -- The poll ID.
*/
pub async fn webinar_poll_delete(
&self,
webinar_id: i64, poll_id: &str,
) -> Result<()> {
let url =
...
let url =
format!("/webinars/{}/registrants/questions",
crate::progenitor_support::encode_path(&webinar_id.to_string()),);
...
&self,
webinar_id: &str, registrant_id: &str, webinar_id: i64, registrant_id: &str, occurrence_id: &str,
...
let url =
format!("/webinars/{}/registrants/{}?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),crate::progenitor_support::encode_path(&registrant_id.to_string()),query);
...
&self,
occurrence_id: &str, page_size: i64, next_page_token: &str, webinar_uuid: &str,
) -> Result<crate::types::UserList> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !next_page_token.is_empty() { query_args.push(format!("next_page_token={}", next_page_token)); }
...
let url =
format!("/past_webinars/{}/absentees?{}",
crate::progenitor_support::encode_path(&webinar_uuid.to_string()),query);
...
&self,
webinar_id: &str, webinar_id: i64,
) -> Result<crate::types::GetTrackingSourcesResponse> {
let url =
format!("/webinars/{}/tracking_sources",
crate::progenitor_support::encode_path(&webinar_id.to_string()),);
...
*/
pub async fn list_webinar_template(
&self,
user_id: &str,
) -> Result<crate::types::ListWebinarTemplatesResponseData> {
let url =
format!("/users/{}/webinar_templates",
crate::progenitor_support::encode_path(&user_id.to_string()),);
...
let url =
format!("/webinars/{}/livestream/status",
crate::progenitor_support::encode_path(&webinar_id.to_string()),);
