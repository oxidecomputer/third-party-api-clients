...
let url =
format!("/webinars/{}?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),query_);
...
let resp: crate::types::ListWebinarParticipantsResponse = self.client.get(&url, None).await.unwrap();
...
let mut resp: crate::types::ListWebinarParticipantsResponse = self.client.get(&url, None).await.unwrap();
...
let url =
format!("/webinars/{}/registrants/{}?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),crate::progenitor_support::encode_path(&registrant_id.to_string()),query_);
...
crate::progenitor_support::encode_path(&webinar_uuid.to_string()),query_);
