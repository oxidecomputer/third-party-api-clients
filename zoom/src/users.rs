...
&self,
user_id: &str, login_type: crate::types::LoginType, option: crate::types::Option, custom_query_fields: &str,
...
&self,
account_id: &str, user_id: &str, account_id: &str,
...
&self,
user_id: &str, file_ids: &str, user_id: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
