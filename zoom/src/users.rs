...
&self,
status: crate::types::UsersStatus, page_size: i64, role_id: &str, page_number: &str, include_fields: crate::types::UsersIncludeFields, next_page_token: &str,
...
if !page_number.is_empty() { query_args.push(format!("page_number={}", page_number)); }
if page_size > 0 { query_args.push(format!("page_size={}", page_size)); }
if !role_id.is_empty() { query_args.push(format!("role_id={}", role_id)); }
...
&self,
status: crate::types::UsersStatus, role_id: &str, include_fields: crate::types::UsersIncludeFields,
) -> Result<Vec<crate::types::UsersResponse>> {
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("include_fields={}", include_fields));
...
let mut resp: crate::types::UsersResponseData = self.client.get(&url, None).await.unwrap();
            ...
            while !page.is_empty() {
                ...
                if !url.contains('?') {
                    resp = self.client.get(&format!("{}?next_page_token={}", url, page), None).await.unwrap();
                } else {
                    resp = self.client.get(&format!("{}&next_page_token={}", url, page), None).await.unwrap();
                }
...
pub async fn user(
&self,
user_id: &str, login_type: crate::types::LoginType, encrypted_email: bool,
) -> Result<crate::types::UserResponseAllOf> {
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
if encrypted_email { query_args.push(format!("encrypted_email={}", encrypted_email)); }
...
let url =
format!("/users/{}?{}",
crate::progenitor_support::encode_path(&user_id.to_string()),query_);
...
&self,
user_id: &str, action: crate::types::UserDeleteAction, transfer_email: &str, transfer_meeting: bool, transfer_webinar: bool, transfer_recording: bool,
) -> Result<()> {
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("action={}", action));
if !transfer_email.is_empty() { query_args.push(format!("transfer_email={}", transfer_email)); }
if transfer_meeting { query_args.push(format!("transfer_meeting={}", transfer_meeting)); }
if transfer_recording { query_args.push(format!("transfer_recording={}", transfer_recording)); }
if transfer_webinar { query_args.push(format!("transfer_webinar={}", transfer_webinar)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query_.push('&');
                    }
...
&self,
user_id: &str, login_type: crate::types::LoginType,
...
* 
*/
pub async fn user_zak(
&self,
) -> Result<crate::types::UserZakResponse> {
let url =
"/users/me/zak".to_string();
self.client.get(&url, None).await
}
...
* * `user_id: &str` -- The user ID or email address of the user. For user-level apps, pass `me` as the value for userId.
*/
pub async fn user_assistant(
&self,
user_id: &str,
) -> Result<crate::types::UserAssistantsList> {
let url =
format!("/users/{}/assistants",
...
* * `user_id: &str` -- The user ID or email address of the user. For user-level apps, pass `me` as the value for userId.
*/
pub async fn user_assistants_delete(
&self,
user_id: &str,
) -> Result<()> {
let url =
...
*/
pub async fn user_assistant_delete(
&self,
user_id: &str, assistant_id: &str,
) -> Result<()> {
let url =
format!("/users/{}/assistants/{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&assistant_id.to_string()),);
...
* * `user_id: &str` -- The user ID or email address of the user. For user-level apps, pass `me` as the value for userId.
*/
pub async fn user_scheduler(
&self,
user_id: &str,
) -> Result<crate::types::UserSchedulersList> {
let url =
format!("/users/{}/schedulers",
crate::progenitor_support::encode_path(&user_id.to_string()),);
...
* * `user_id: &str` -- The user ID or email address of the user. For user-level apps, pass `me` as the value for userId.
*/
pub async fn user_schedulers_delete(
&self,
user_id: &str,
) -> Result<()> {
let url =
...
*/
pub async fn user_scheduler_delete(
&self,
user_id: &str, scheduler_id: &str,
) -> Result<()> {
let url =
format!("/users/{}/schedulers/{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&scheduler_id.to_string()),);
...
* * `user_id: &str` -- The user ID or email address of the user. For user-level apps, pass `me` as the value for userId.
*/
pub async fn user_picture(
&self,
user_id: &str,
) -> Result<()> {
let url =
format!("/users/{}/picture",
crate::progenitor_support::encode_path(&user_id.to_string()),);
...
&self,
user_id: &str, login_type: crate::types::LoginType, option: crate::types::OptionData, custom_query_fields: &str,
...
&self,
option: crate::types::UserSettingsUpdateOption, user_id: &str,
...
&self,
user_id: &str,
) -> Result<crate::types::UserPermissions> {
let url =
...
&self,
user_id: &str, type_: crate::types::UserTokenType, ttl: i64,
) -> Result<crate::types::UserZakResponse> {
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
if ttl > 0 { query_args.push(format!("ttl={}", ttl)); }
...
* * `user_id: &str` -- The user ID or email address of the user. For user-level apps, pass `me` as the value for userId.
*/
pub async fn user_sso_token_delete(
&self,
user_id: &str,
) -> Result<()> {
let url =
...
&self,
email: &str,
) -> Result<crate::types::UserEmailResponse> {
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
...
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
if !vanity_name.is_empty() { query_args.push(format!("vanity_name={}", vanity_name)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query_.push('&');
                    }
...
let url =
format!("/accounts/{}/users/{}/account",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),);
...
let url =
format!("/users/{}/settings/virtual_backgrounds",
crate::progenitor_support::encode_path(&user_id.to_string()),);
...
*/
pub async fn del_user_vb(
&self,
user_id: &str, file_ids: &str,
) -> Result<()> {
let mut query_ = String::new();
let mut query_args: Vec<String> = Default::default();
if !file_ids.is_empty() { query_args.push(format!("file_ids={}", file_ids)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query_.push('&');
                    }
