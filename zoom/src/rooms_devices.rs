...
&self,
room_id: &str, device_id: &str, room_id: &str, device_id: &str,
body: &crate::types::ChangeZoomRoomsAppVersionRequest
) -> Result<()> {
let url =
format!("/rooms/{}/devices/{}/app_version",
crate::progenitor_support::encode_path(&room_id.to_string()),crate::progenitor_support::encode_path(&device_id.to_string()),);
