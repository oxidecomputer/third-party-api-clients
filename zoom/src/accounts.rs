...
) -> Result<crate::types::AccountList> {
...
&self,
account_id: &str,
) -> Result<crate::types::AccountResponse> {
let url =
format!("/accounts/{}",
...
* * `account_id: &str` -- The account ID.
*/
pub async fn account_disassociate(
&self,
account_id: &str,
) -> Result<()> {
let url =
...
&self,
account_id: &str, option: crate::types::Option, custom_query_fields: &str,
...
&self,
account_id: &str, option: crate::types::AccountSettingsUpdateOption,
...
let url =
format!("/accounts/{}/managed_domains",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
let url =
format!("/accounts/{}/trusted_domains",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
&self,
account_id: &str, account_id: &str, option: &str, custom_query_fields: &str,
) -> Result<crate::types::Domains> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !custom_query_fields.is_empty() { query_args.push(format!("custom_query_fields={}", custom_query_fields)); }
...
let url =
format!("/accounts/{}/settings/virtual_backgrounds",
crate::progenitor_support::encode_path(&account_id.to_string()),);
