...
let url =
format!("/accounts/{}/sip_trunk/settings",
...
let url =
format!("/accounts/{}/sip_trunk/numbers",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
let url =
format!("/accounts/{}/sip_trunk/trunks",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
&self,
account_id: &str, trunk_id: &str, account_id: &str, trunk_id: &str,
) -> Result<crate::types::Domains> {
let url =
format!("/accounts/{}/sip_trunk/trunks/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&trunk_id.to_string()),);
...
let url =
format!("/accounts/{}/sip_trunk/callout_countries",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
&self,
account_id: &str, country_id: &str, account_id: &str, country_id: &str,
) -> Result<()> {
let url =
format!("/accounts/{}/sip_trunk/callout_countries/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&country_id.to_string()),);
...
&self,
account_id: &str, account_id: &str, page_size: i64, next_page_token: &str,
...
let url =
format!("/accounts/{}/sip_trunk/internal_numbers?{}",
...
&self,
account_id: &str, number_id: &str, account_id: &str, number_id: &str,
) -> Result<()> {
let url =
format!("/accounts/{}/sip_trunk/internal_numbers/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&number_id.to_string()),);
