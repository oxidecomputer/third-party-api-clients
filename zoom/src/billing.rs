...
let url =
format!("/accounts/{}/plans/base/status",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
let url =
format!("/accounts/{}/plans/addons/status",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
&self,
account_id: &str, from: chrono::NaiveDate, to: chrono::NaiveDate,
...
let url =
format!("/api/download/billing/invoices/{}",
