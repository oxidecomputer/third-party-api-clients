...
pub async fn (
&self,
user_id: &str, type_: crate::types::MeetingType, page_size: i64, next_page_token: &str, page_number: &str,
...
&self,
meeting_id: i64, occurrence_id: &str, show_previous_occurrences: bool,
...
&self,
meeting_id: i64, occurrence_id: &str, schedule_for_reminder: bool, cancel_meeting_reminder: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !cancel_meeting_reminder.is_empty() { query_args.push(format!("cancel_meeting_reminder={}", cancel_meeting_reminder)); }
if !occurrence_id.is_empty() { query_args.push(format!("occurrence_id={}", occurrence_id)); }
if schedule_for_reminder { query_args.push(format!("schedule_for_reminder={}", schedule_for_reminder)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
&self,
meeting_id: i64, occurrence_id: &str,
...
&self,
meeting_id: i64, occurrence_id: &str, status: crate::types::RegistrantStatusData, page_size: i64, page_number: i64, next_page_token: &str,
...
&self,
meeting_id: i64, occurrence_ids: &str,
...
&self,
occurrence_id: &str, meeting_id: i64, registrant_id: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !occurrence_id.is_empty() { query_args.push(format!("occurrence_id={}", occurrence_id)); }
...
let url =
format!("/meetings/{}/registrants/{}?{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),crate::progenitor_support::encode_path(&registrant_id.to_string()),query);
...
let url =
format!("/meetings/{}/registrants/status?{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),query);
...
&self,
meeting_uuid: &str, page_size: i64, next_page_token: &str,
...
let url =
format!("/past_meetings/{}/participants?{}",
crate::progenitor_support::encode_path(&meeting_uuid.to_string()),query);
...
*  While storing it in your database, store it as a \*\*long\*\* data type and \*\*not as an integer\*\*, as the Meeting IDs can be longer than 10 digits.
*/
pub async fn past_meeting(
&self,
meeting_id: i64,
) -> Result<crate::types::MeetingInstances> {
let url =
format!("/past_meetings/{}/instances",
crate::progenitor_support::encode_path(&meeting_id.to_string()),);
...
*  While storing it in your database, store it as a \*\*long\*\* data type and \*\*not as an integer\*\*, as the Meeting IDs can be longer than 10 digits.
*/
pub async fn meeting_poll(
&self,
meeting_id: i64,
) -> Result<crate::types::PollList> {
let url =
format!("/meetings/{}/polls",
crate::progenitor_support::encode_path(&meeting_id.to_string()),);
...
&self,
meeting_id: i64, poll_id: &str,
) -> Result<crate::types::MeetingPollGetResponse> {
let url =
format!("/meetings/{}/polls/{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),crate::progenitor_support::encode_path(&poll_id.to_string()),);
...
* * `poll_id: &str` -- The poll ID.
*/
pub async fn meeting_poll_delete(
&self,
meeting_id: i64, poll_id: &str,
) -> Result<()> {
let url =
...
let url =
format!("/meetings/{}/registrants/questions",
crate::progenitor_support::encode_path(&meeting_id.to_string()),);
...
let url =
format!("/meetings/{}/livestream/status",
crate::progenitor_support::encode_path(&meeting_id.to_string()),);
...
let url =
format!("/meetings/{}/batch_registrants",
crate::progenitor_support::encode_path(&meeting_id.to_string()),);
...
*/
pub async fn meeting_quality_score(
&self,
...
let url =
format!("/users/{}/meeting_templates",
crate::progenitor_support::encode_path(&user_id.to_string()),);
