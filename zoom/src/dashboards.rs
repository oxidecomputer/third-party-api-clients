...
&self,
type_: crate::types::MeetingTypePast, from: chrono::NaiveDate, to: chrono::NaiveDate, page_size: i64, next_page_token: &str, include_fields: crate::types::IncludeFields,
...
* * `type_: crate::types::MeetingTypePast` -- The meeting types: <br>`past` - Past meetings.<br>`pastOne` - Past one user meetings.<br>`live` - Live meetings.
*/
pub async fn dashboard_meeting_detail(
&self,
meeting_id: &str, type_: crate::types::MeetingTypePast,
...
&self,
meeting_id: &str, type_: crate::types::MeetingTypePast, page_size: i64, next_page_token: &str, include_fields: crate::types::DashboardMeetingParticipantsIncludeFields,
...
let url =
format!("/metrics/meetings/{}/participants?{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),query);
...
* * `type_: crate::types::MeetingTypePast` -- The meeting types: <br>`past` - Past meetings.<br>`live` - Live Meetings.
*/
pub async fn dashboard_meeting_participant_qo(
&self,
meeting_id: &str, participant_id: &str, type_: crate::types::MeetingTypePast,
...
let url =
format!("/metrics/meetings/{}/participants/{}/qos?{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),crate::progenitor_support::encode_path(&participant_id.to_string()),query);
...
&self,
meeting_id: &str, type_: crate::types::MeetingTypePast, page_size: i64, next_page_token: &str,
...
let url =
format!("/metrics/meetings/{}/participants/sharing?{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),query);
...
* **Parameters:**
*
* * `type_: crate::types::WebinarTypePast` -- The webinar type.
* * `from: chrono::NaiveDate` -- Start date in 'yyyy-mm-dd' format. The date range defined by the "from" and "to" parameters should only be one month as the report includes only one month worth of data at once.
* * `to: chrono::NaiveDate` -- End date.
* * `page_size: i64` -- The number of records returned within a single API call.
* * `next_page_token: &str` -- The next page token is used to paginate through large result sets. A next page token will be returned whenever the set of available results exceeds the current page size. The expiration period for this token is 15 minutes.
...
&self,
type_: crate::types::WebinarTypePast, from: chrono::NaiveDate, to: chrono::NaiveDate, page_size: i64, next_page_token: &str,
) -> Result<crate::types::DashboardMeetingsResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("from={}", from));
...
&self,
webinar_id: &str, type_: crate::types::WebinarTypePast,
...
&self,
webinar_id: &str, type_: crate::types::WebinarTypePast, page_size: i64, next_page_token: &str, include_fields: crate::types::DashboardMeetingParticipantsIncludeFields,
) -> Result<crate::types::PaginationToken> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("include_fields={}", include_fields));
...
let url =
format!("/metrics/webinars/{}/participants?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),query);
...
&self,
webinar_id: &str, participant_id: &str, type_: crate::types::WebinarTypePast,
) -> Result<crate::types::ParticipantQos> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("type={}", type_));
...
let url =
format!("/metrics/webinars/{}/participants/{}/qos?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),crate::progenitor_support::encode_path(&participant_id.to_string()),query);
...
&self,
webinar_id: &str, type_: crate::types::WebinarTypePast, page_size: i64, next_page_token: &str,
) -> Result<crate::types::ParticipantQosList> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !next_page_token.is_empty() { query_args.push(format!("next_page_token={}", next_page_token)); }
...
let url =
format!("/metrics/webinars/{}/participants/sharing?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),query);
...
&self,
page_size: i64, page_number: i64, next_page_token: &str,
...
pub async fn dashboard_zoom_room(
&self,
zoomroom_id: &str, from: chrono::NaiveDate, to: chrono::NaiveDate, page_size: i64, next_page_token: &str,
...
let url =
format!("/metrics/zoomrooms/{}?{}",
crate::progenitor_support::encode_path(&zoomroom_id.to_string()),query);
...
let url =
format!("/metrics/client/feedback?{}",
query);
...
let url =
format!("/metrics/zoomrooms/issues?{}",
query);
...
let url =
format!("/metrics/issues/zoomrooms?{}",
query);
...
&self,
feedback_id: &str, from: chrono::NaiveDate, to: chrono::NaiveDate, page_size: i64, next_page_token: &str,
) -> Result<crate::types::ReportCloudRecordingResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("from={}", from));
...
let url =
format!("/metrics/client/feedback/{}?{}",
crate::progenitor_support::encode_path(&feedback_id.to_string()),query);
...
let url =
format!("/metrics/client/satisfaction?{}",
query);
...
&self,
from: &str, to: &str, site_id: &str, quality_type: &str, page_size: i64, next_page_token: &str,
...
if !next_page_token.is_empty() { query_args.push(format!("next_page_token={}", next_page_token)); }
if page_size > 0 { query_args.push(format!("page_size={}", page_size)); }
if !quality_type.is_empty() { query_args.push(format!("quality_type={}", quality_type)); }
...
let url =
format!("/phone/metrics/call_logs?{}",
query);
...
*/
pub async fn get_call_qo_s(
&self,
call_id: &str, call_id: &str,
) -> Result<crate::types::GetCallQoSResponse> {
let url =
format!("/phone/metrics/call_logs/{}/qos",
crate::progenitor_support::encode_path(&call_id.to_string()),);
...
&self,
meeting_id: &str, meeting_id: &str, type_: crate::types::MeetingTypePast, next_page_token: &str, page_size: i64,
...
let url =
format!("/metrics/meetings/{}/participants/satisfaction?{}",
crate::progenitor_support::encode_path(&meeting_id.to_string()),query);
...
&self,
type_: crate::types::MeetingTypePast, page_size: i64, next_page_token: &str, webinar_id: &str,
) -> Result<crate::types::ParticipantFeedbackResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !next_page_token.is_empty() { query_args.push(format!("next_page_token={}", next_page_token)); }
...
let url =
format!("/metrics/webinars/{}/participants/satisfaction?{}",
crate::progenitor_support::encode_path(&webinar_id.to_string()),query);
