...
pub async fn (
&self,
) -> Result<crate::types::ImGroupList> {
let url =
"/im/groups".to_string();
...
*/
pub async fn im_group_members_delete(
&self,
group_id: &str, member_id: &str,
) -> Result<()> {
let url =
format!("/im/groups/{}/members/{}",
