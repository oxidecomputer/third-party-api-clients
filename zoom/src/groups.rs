...
&self,
group_id: &str,
) -> Result<crate::types::GroupResponse> {
let url =
format!("/groups/{}",
...
&self,
group_id: &str, page_size: i64, page_number: i64, next_page_token: &str,
...
let url =
format!("/groups/{}/members?{}",
crate::progenitor_support::encode_path(&group_id.to_string()),query);
...
&self,
group_id: &str, member_id: &str, group_id: &str, member_id: &str,
) -> Result<()> {
let url =
format!("/groups/{}/members/{}",
crate::progenitor_support::encode_path(&group_id.to_string()),crate::progenitor_support::encode_path(&member_id.to_string()),);
...
&self,
group_id: &str, custom_query_fields: &str, option: crate::types::Option,
...
&self,
group_id: &str, custom_query_fields: &str, group_id: &str, option: crate::types::UpdateGroupSettingsOption,
...
&self,
group_id: &str, custom_query_fields: &str, group_id: &str, option: &str,
) -> Result<crate::types::GetGroupLockSettingsResponse> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !custom_query_fields.is_empty() { query_args.push(format!("custom_query_fields={}", custom_query_fields)); }
if !option.is_empty() { query_args.push(format!("option={}", option)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
&self,
file_ids: &str, group_id: &str, group_id: &str,
...
let url =
format!("/groups/{}/settings/virtual_backgrounds?{}",
crate::progenitor_support::encode_path(&group_id.to_string()),query);
...
&self,
file_ids: &str, group_id: &str, group_id: &str, file_ids: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !file_ids.is_empty() { query_args.push(format!("file_ids={}", file_ids)); }
