...
&self,
call_queue_id: &str, call_queue_id: &str,
...
let url =
format!("/phone/call_queues/{}/phone_numbers",
crate::progenitor_support::encode_path(&call_queue_id.to_string()),);
...
&self,
call_queue_id: &str, phone_number_id: &str, call_queue_id: &str, phone_number_id: &str,
) -> Result<crate::types::Domains> {
let url =
format!("/phone/call_queues/{}/phone_numbers/{}",
crate::progenitor_support::encode_path(&call_queue_id.to_string()),crate::progenitor_support::encode_path(&phone_number_id.to_string()),);
...
let url =
format!("/phone/call_queues/{}/members",
crate::progenitor_support::encode_path(&call_queue_id.to_string()),);
...
&self,
call_queue_id: &str, member_id: &str, call_queue_id: &str, member_id: &str,
) -> Result<()> {
let url =
format!("/phone/call_queues/{}/members/{}",
crate::progenitor_support::encode_path(&call_queue_id.to_string()),crate::progenitor_support::encode_path(&member_id.to_string()),);
...
let url =
format!("/phone/call_queues/{}/manager",
crate::progenitor_support::encode_path(&call_queue_id.to_string()),);
...
&self,
call_queue_id: &str, call_queue_id: &str, page_size: i64, next_page_token: &str, from: chrono::NaiveDate, to: chrono::NaiveDate,
...
let url =
format!("/phone/call_queues/{}/recordings?{}",
crate::progenitor_support::encode_path(&call_queue_id.to_string()),query);
