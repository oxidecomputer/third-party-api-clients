...
&self,
user_id: &str, channel_id: &str, channel_id: &str, user_id: &str,
) -> Result<crate::types::Channel> {
let url =
format!("/chat/users/{}/channels/{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&channel_id.to_string()),);
...
&self,
user_id: &str, channel_id: &str, channel_id: &str,
) -> Result<()> {
let url =
format!("/chat/users/{}/channels/{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&channel_id.to_string()),);
...
&self,
user_id: &str, channel_id: &str, channel_id: &str, page_size: i64, next_page_token: &str, user_id: &str,
...
let url =
format!("/chat/users/{}/channels/{}/members?{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&channel_id.to_string()),query);
...
&self,
user_id: &str, channel_id: &str, member_id: &str, channel_id: &str, member_id: &str, user_id: &str,
) -> Result<()> {
let url =
format!("/chat/users/{}/channels/{}/members/{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&channel_id.to_string()),crate::progenitor_support::encode_path(&member_id.to_string()),);
