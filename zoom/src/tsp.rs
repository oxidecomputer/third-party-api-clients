...
pub async fn (
&self,
) -> Result<crate::types::TspResponse> {
let url =
"/tsp".to_string();
...
pub async fn update(
&self,
body: &crate::types::UpdateRequest
) -> Result<()> {
let url =
"/tsp".to_string();
...
&self,
user_id: &str,
) -> Result<crate::types::UserTsPsResponse> {
let url =
format!("/users/{}/tsp",
...
*/
pub async fn user_tsp(
&self,
user_id: &str, tsp_id: &str,
) -> Result<crate::types::TspAccount> {
let url =
format!("/users/{}/tsp/{}",
crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&tsp_id.to_string()),);
