...
let url =
format!("/phone/common_area_phones?{}",
query);
...
let url =
"/phone/common_area_phones".to_string();
...
&self,
common_area_phone_id: &str, common_area_phone_id: &str,
...
let url =
format!("/phone/common_area_phones/{}/phone_numbers",
crate::progenitor_support::encode_path(&common_area_phone_id.to_string()),);
...
&self,
common_area_phone_id: &str, phone_number_id: &str,
) -> Result<()> {
let url =
format!("/phone/common_area_phones/{}/phone_numbers/{}",
crate::progenitor_support::encode_path(&common_area_phone_id.to_string()),crate::progenitor_support::encode_path(&phone_number_id.to_string()),);
...
let url =
format!("/phone/common_area_phones/{}/calling_plans",
crate::progenitor_support::encode_path(&common_area_phone_id.to_string()),);
...
&self,
common_area_phone_id: &str, type_: &str,
) -> Result<()> {
let url =
format!("/phone/common_area_phones/{}/calling_plans/{}",
crate::progenitor_support::encode_path(&common_area_phone_id.to_string()),crate::progenitor_support::encode_path(&type_.to_string()),);
