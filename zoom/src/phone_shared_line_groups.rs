...
&self,
page_size: i64, next_page_token: &str,
...
let url =
format!("/phone/shared_line_groups?{}",
query);
...
let url =
"/phone/shared_line_groups".to_string();
...
&self,
shared_line_group_id: &str, shared_line_group_id: &str,
...
let url =
format!("/phone/shared_line_groups/{}/members",
crate::progenitor_support::encode_path(&shared_line_group_id.to_string()),);
...
&self,
shared_line_group_id: &str, member_id: &str, shared_line_group_id: &str, member_id: &str,
) -> Result<()> {
let url =
format!("/phone/shared_line_groups/{}/members/{}",
crate::progenitor_support::encode_path(&shared_line_group_id.to_string()),crate::progenitor_support::encode_path(&member_id.to_string()),);
...
let url =
format!("/phone/shared_line_groups/{}/phone_numbers",
crate::progenitor_support::encode_path(&shared_line_group_id.to_string()),);
...
&self,
shared_line_group_id: &str, phone_number_id: &str, shared_line_group_id: &str, phone_number_id: &str,
) -> Result<()> {
let url =
format!("/phone/shared_line_groups/{}/phone_numbers/{}",
crate::progenitor_support::encode_path(&shared_line_group_id.to_string()),crate::progenitor_support::encode_path(&phone_number_id.to_string()),);
