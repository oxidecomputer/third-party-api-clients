...
&self,
from: &str, to: &str, category_type: &str, page_size: i64, next_page_token: &str,
) -> Result<crate::types::PaginationToken4ImChat> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !category_type.is_empty() { query_args.push(format!("category_type={}", category_type)); }
...
let url =
format!("/phone/reports/operationlogs?{}",
query);
