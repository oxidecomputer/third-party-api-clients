...
&self,
status: &str, limit: &str, since_id: &str, fields: &str,
) -> Result<()> {
...
let url =
format!("/admin/api/2020-01/gift_cards.json?{}",
query_);
...
let url =
"/admin/api/2020-01/gift_cards.json".to_string();
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/gift_cards/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/gift_cards/{}/disable.json",
crate::progenitor_support::encode_path(&gift_card_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/gift_cards/search.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/gift_cards.json?{}",
query_);
...
let url =
"/admin/api/2020-04/gift_cards.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/gift_cards/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-04/gift_cards/{}/disable.json",
crate::progenitor_support::encode_path(&gift_card_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/gift_cards/search.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/gift_cards.json?{}",
query_);
...
let url =
"/admin/api/2020-07/gift_cards.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/gift_cards/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-07/gift_cards/{}/disable.json",
crate::progenitor_support::encode_path(&gift_card_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/gift_cards/search.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/gift_cards.json?{}",
query_);
...
let url =
"/admin/api/2020-10/gift_cards.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/gift_cards/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-10/gift_cards/{}/disable.json",
crate::progenitor_support::encode_path(&gift_card_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/gift_cards/search.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/gift_cards.json?{}",
query_);
...
let url =
"/admin/api/2021-01/gift_cards.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/gift_cards/count.json?{}",
query_);
...
let url =
format!("/admin/api/2021-01/gift_cards/{}/disable.json",
crate::progenitor_support::encode_path(&gift_card_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/gift_cards/search.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/gift_cards.json?{}",
query_);
...
let url =
"/admin/api/unstable/gift_cards.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/gift_cards/count.json?{}",
query_);
...
let url =
format!("/admin/api/unstable/gift_cards/{}/disable.json",
crate::progenitor_support::encode_path(&gift_card_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/gift_cards/search.json?{}",
query_);
...
&self,
limit: &str, page_info: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
if !page_info.is_empty() { query_args.push(("page_info".to_string(), page_info.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/users.json?{}",
query_);
...
*/
pub async fn deprecated_202001_get_users_current(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/users/current.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/users.json?{}",
query_);
...
*/
pub async fn deprecated_202004_get_users_current(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-04/users/current.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/users.json?{}",
query_);
...
*/
pub async fn deprecated_202007_get_users_current(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-07/users/current.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/users.json?{}",
query_);
...
* * `user_id: &str` -- storefront_access_token_id.
*/
pub async fn get_users_param_user(
&self,
user_id: &str,
) -> Result<()> {
let url =
...
let url =
"/admin/api/2020-10/users/current.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/users.json?{}",
query_);
...
*/
pub async fn deprecated_202101_get_users_current(
&self,
) -> Result<()> {
let url =
"/admin/api/2021-01/users/current.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/users.json?{}",
query_);
...
*/
pub async fn deprecated_unstable_get_users_current(
&self,
) -> Result<()> {
let url =
"/admin/api/unstable/users/current.json".to_string();
self.client.get(&url, None).await
}
