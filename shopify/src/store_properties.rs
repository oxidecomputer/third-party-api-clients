...
let url =
format!("/admin/api/2020-01/countries.json?{}",
query_);
...
let url =
"/admin/api/2020-01/countries.json".to_string();
...
*/
pub async fn deprecated_202001_get_countries_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/countries/count.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-01/countries/{}/json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/countries.json?{}",
query_);
...
let url =
"/admin/api/2020-04/countries.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
*/
pub async fn deprecated_202004_get_countries_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-04/countries/count.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/countries.json?{}",
query_);
...
let url =
"/admin/api/2020-07/countries.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
*/
pub async fn deprecated_202007_get_countries_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-07/countries/count.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/countries.json?{}",
query_);
...
let url =
"/admin/api/2020-10/countries.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
"/admin/api/2020-10/countries/count.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/countries.json?{}",
query_);
...
let url =
"/admin/api/2021-01/countries.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
*/
pub async fn deprecated_202101_get_countries_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2021-01/countries/count.json".to_string();
self.client.get(&url, None).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/countries.json?{}",
query_);
...
let url =
"/admin/api/unstable/countries.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
*/
pub async fn deprecated_202001_get_currencie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/currencies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202004_get_currencie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-04/currencies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202007_get_currencie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-07/currencies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn get_currencie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-10/currencies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202101_get_currencie(
&self,
) -> Result<()> {
let url =
"/admin/api/2021-01/currencies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_unstable_get_currencie(
&self,
) -> Result<()> {
let url =
"/admin/api/unstable/currencies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202001_get_policie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/policies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202004_get_policie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-04/policies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202007_get_policie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-07/policies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn get_policie(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-10/policies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_202101_get_policie(
&self,
) -> Result<()> {
let url =
"/admin/api/2021-01/policies.json".to_string();
self.client.get(&url, None).await
}
...
*/
pub async fn deprecated_unstable_get_policie(
&self,
) -> Result<()> {
let url =
"/admin/api/unstable/policies.json".to_string();
self.client.get(&url, None).await
}
...
&self,
country_id: &str, since_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/countries/{}/provinces.json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-01/countries/{}/provinces/count.json",
crate::progenitor_support::encode_path(&country_id.to_string()),);
...
&self,
country_id: &str, province_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/countries/{}/provinces/{}/json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),crate::progenitor_support::encode_path(&province_id.to_string()),query_);
...
&self,
country_id: &str, province_id: &str,
body: &serde_json::Value
) -> Result<()> {
let url =
format!("/admin/api/2020-01/countries/{}/provinces/{}/json",
crate::progenitor_support::encode_path(&country_id.to_string()),crate::progenitor_support::encode_path(&province_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/countries/{}/provinces.json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-04/countries/{}/provinces/count.json",
crate::progenitor_support::encode_path(&country_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/countries/{}/provinces.json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-07/countries/{}/provinces/count.json",
crate::progenitor_support::encode_path(&country_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/countries/{}/provinces.json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-10/countries/{}/provinces/count.json",
crate::progenitor_support::encode_path(&country_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/countries/{}/provinces.json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let url =
format!("/admin/api/2021-01/countries/{}/provinces/count.json",
crate::progenitor_support::encode_path(&country_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/countries/{}/provinces.json?{}",
crate::progenitor_support::encode_path(&country_id.to_string()),query_);
...
let url =
format!("/admin/api/unstable/countries/{}/provinces/count.json",
crate::progenitor_support::encode_path(&country_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/shipping_zones.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/shipping_zones.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/shipping_zones.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/shipping_zones.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/shipping_zones.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/shipping_zones.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/shop.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/shop.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/shop.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/shop.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/shop.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/shop.json?{}",
query_);
