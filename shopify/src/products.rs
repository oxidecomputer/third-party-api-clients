...
&self,
limit: &str, since_id: &str, fields: &str,
) -> Result<()> {
...
let url =
format!("/admin/api/2020-01/collects.json?{}",
query_);
...
let url =
"/admin/api/2020-01/collects.json".to_string();
...
let url =
format!("/admin/api/2020-01/collects/{}/json?{}",
crate::progenitor_support::encode_path(&collect_id.to_string()),query_);
...
let mut query_args: Vec<(String, String)> = Default::default();
if collection_id > 0 { query_args.push(("collection_id".to_string(), collection_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/collects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/collects.json?{}",
query_);
...
let url =
"/admin/api/2020-04/collects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/collects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/collects.json?{}",
query_);
...
let url =
"/admin/api/2020-07/collects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/collects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/collects.json?{}",
query_);
...
let url =
"/admin/api/2020-10/collects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/collects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/collects.json?{}",
query_);
...
let url =
"/admin/api/2021-01/collects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/collects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/collects.json?{}",
query_);
...
let url =
"/admin/api/unstable/collects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/collects/count.json?{}",
query_);
...
&self,
collection_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/collections/{}/json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
&self,
collection_id: &str, limit: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/collections/{}/products.json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/collections/{}/json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/collections/{}/products.json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/collections/{}/json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/collections/{}/products.json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/collections/{}/json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/collections/{}/products.json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/collections/{}/json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/collections/{}/products.json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/collections/{}/json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/collections/{}/products.json?{}",
crate::progenitor_support::encode_path(&collection_id.to_string()),query_);
...
&self,
limit: &str, ids: &str, since_id: &str, title: &str, product_id: &str, handle: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !handle.is_empty() { query_args.push(("handle".to_string(), handle.to_string())); }
if !ids.is_empty() { query_args.push(("ids".to_string(), ids.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
if !product_id.is_empty() { query_args.push(("product_id".to_string(), product_id.to_string())); }
if !published_at_max.is_empty() { query_args.push(("published_at_max".to_string(), published_at_max.to_string())); }
if !published_at_min.is_empty() { query_args.push(("published_at_min".to_string(), published_at_min.to_string())); }
if !published_status.is_empty() { query_args.push(("published_status".to_string(), published_status.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
if !title.is_empty() { query_args.push(("title".to_string(), title.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/custom_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-01/custom_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
&self,
title: &str, product_id: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !product_id.is_empty() { query_args.push(("product_id".to_string(), product_id.to_string())); }
if !published_at_max.is_empty() { query_args.push(("published_at_max".to_string(), published_at_max.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/custom_collections/count.json?{}",
query_);
...
&self,
custom_collection_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/custom_collections/{}/json?{}",
crate::progenitor_support::encode_path(&custom_collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/custom_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-04/custom_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/custom_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/custom_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-07/custom_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/custom_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/custom_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-10/custom_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/custom_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/custom_collections.json?{}",
query_);
...
let url =
"/admin/api/2021-01/custom_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/custom_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/custom_collections.json?{}",
query_);
...
let url =
"/admin/api/unstable/custom_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/custom_collections/count.json?{}",
query_);
...
&self,
ids: &str, limit: &str, since_id: &str, title: &str, vendor: &str, handle: &str, product_type: &str, status: &str, collection_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str, fields: &str, presentment_currencies: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !collection_id.is_empty() { query_args.push(("collection_id".to_string(), collection_id.to_string())); }
...
if !ids.is_empty() { query_args.push(("ids".to_string(), ids.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
if !presentment_currencies.is_empty() { query_args.push(("presentment_currencies".to_string(), presentment_currencies.to_string())); }
if !product_type.is_empty() { query_args.push(("product_type".to_string(), product_type.to_string())); }
if !published_at_max.is_empty() { query_args.push(("published_at_max".to_string(), published_at_max.to_string())); }
if !published_at_min.is_empty() { query_args.push(("published_at_min".to_string(), published_at_min.to_string())); }
if !published_status.is_empty() { query_args.push(("published_status".to_string(), published_status.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
if !status.is_empty() { query_args.push(("status".to_string(), status.to_string())); }
if !title.is_empty() { query_args.push(("title".to_string(), title.to_string())); }
if !updated_at_max.is_empty() { query_args.push(("updated_at_max".to_string(), updated_at_max.to_string())); }
if !updated_at_min.is_empty() { query_args.push(("updated_at_min".to_string(), updated_at_min.to_string())); }
if !vendor.is_empty() { query_args.push(("vendor".to_string(), vendor.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/products.json?{}",
query_);
...
let url =
"/admin/api/2020-01/products.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
&self,
vendor: &str, product_type: &str, collection_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !collection_id.is_empty() { query_args.push(("collection_id".to_string(), collection_id.to_string())); }
if !created_at_max.is_empty() { query_args.push(("created_at_max".to_string(), created_at_max.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/products/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/products/{}/json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/products.json?{}",
query_);
...
let url =
"/admin/api/2020-04/products.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/products/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/products.json?{}",
query_);
...
let url =
"/admin/api/2020-07/products.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/products/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/products.json?{}",
query_);
...
let url =
"/admin/api/2020-10/products.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/products/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/products.json?{}",
query_);
...
let url =
"/admin/api/2021-01/products.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/products/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/products.json?{}",
query_);
...
let url =
"/admin/api/unstable/products.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/products/count.json?{}",
query_);
...
&self,
product_id: &str, since_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/products/{}/images.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
&self,
product_id: &str, since_id: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/products/{}/images/count.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
&self,
product_id: &str, image_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/products/{}/images/{}/json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),crate::progenitor_support::encode_path(&image_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-01/products/{}/images/{}/json",
crate::progenitor_support::encode_path(&product_id.to_string()),crate::progenitor_support::encode_path(&image_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/products/{}/images.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/products/{}/images/count.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/products/{}/images.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/products/{}/images/count.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/products/{}/images.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/products/{}/images/count.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/products/{}/images.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/products/{}/images/count.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/products/{}/images.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/products/{}/images/count.json?{}",
crate::progenitor_support::encode_path(&product_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/smart_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-01/smart_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/smart_collections/count.json?{}",
query_);
...
&self,
smart_collection_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/smart_collections/{}/json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
...
&self,
smart_collection_id: &str, products: &str, sort_order: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !products.is_empty() { query_args.push(("products".to_string(), products.to_string())); }
if !sort_order.is_empty() { query_args.push(("sort_order".to_string(), sort_order.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/smart_collections/{}/order.json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/smart_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-04/smart_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/smart_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/smart_collections/{}/order.json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/smart_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-07/smart_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/smart_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/smart_collections/{}/order.json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/smart_collections.json?{}",
query_);
...
let url =
"/admin/api/2020-10/smart_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/smart_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/smart_collections/{}/order.json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/smart_collections.json?{}",
query_);
...
let url =
"/admin/api/2021-01/smart_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/smart_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/smart_collections/{}/order.json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/smart_collections.json?{}",
query_);
...
let url =
"/admin/api/unstable/smart_collections.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/smart_collections/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/smart_collections/{}/order.json?{}",
crate::progenitor_support::encode_path(&smart_collection_id.to_string()),query_);
