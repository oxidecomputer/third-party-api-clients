...
&self,
ids_required: &str, limit: &str, ids: i64,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if ids > 0 { query_args.push(("ids".to_string(), ids.to_string())); }
if !ids_required.is_empty() { query_args.push(("ids
                  required".to_string(), ids_required.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/inventory_items.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/inventory_items.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/inventory_items.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/inventory_items.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/inventory_items.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/inventory_items.json?{}",
query_);
...
&self,
inventory_item_ids: &str, location_ids: &str, limit: &str, updated_at_min: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !inventory_item_ids.is_empty() { query_args.push(("inventory_item_ids".to_string(), inventory_item_ids.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/inventory_levels.json?{}",
query_);
...
&self,
inventory_item_id_required: &str, location_id_required: &str, inventory_item_id: i64, location_id: i64,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if inventory_item_id > 0 { query_args.push(("inventory_item_id".to_string(), inventory_item_id.to_string())); }
if !inventory_item_id_required.is_empty() { query_args.push(("inventory_item_id
                  required".to_string(), inventory_item_id_required.to_string())); }
if location_id > 0 { query_args.push(("location_id".to_string(), location_id.to_string())); }
if !location_id_required.is_empty() { query_args.push(("location_id
                  required".to_string(), location_id_required.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/inventory_levels.json?{}",
query_);
...
&self,
inventory_item_id_required: &str, location_id_required: &str, available_adjustment_required: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !available_adjustment_required.is_empty() { query_args.push(("available_adjustment
                  required".to_string(), available_adjustment_required.to_string())); }
if !inventory_item_id_required.is_empty() { query_args.push(("inventory_item_id
                  required".to_string(), inventory_item_id_required.to_string())); }
if !location_id_required.is_empty() { query_args.push(("location_id
                  required".to_string(), location_id_required.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/inventory_levels/adjust.json?{}",
query_);
...
&self,
inventory_item_id_required: &str, location_id_required: &str, relocate_if_necessary: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !inventory_item_id_required.is_empty() { query_args.push(("inventory_item_id
...
if !location_id_required.is_empty() { query_args.push(("location_id
                  required".to_string(), location_id_required.to_string())); }
if !relocate_if_necessary.is_empty() { query_args.push(("relocate_if_necessary".to_string(), relocate_if_necessary.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/inventory_levels/connect.json?{}",
query_);
...
&self,
inventory_item_id_required: &str, location_id_required: &str, available_required: &str, disconnect_if_necessary: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !available_required.is_empty() { query_args.push(("available
                  required".to_string(), available_required.to_string())); }
if !disconnect_if_necessary.is_empty() { query_args.push(("disconnect_if_necessary".to_string(), disconnect_if_necessary.to_string())); }
if !inventory_item_id_required.is_empty() { query_args.push(("inventory_item_id
                  required".to_string(), inventory_item_id_required.to_string())); }
if !location_id_required.is_empty() { query_args.push(("location_id
                  required".to_string(), location_id_required.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/inventory_levels/set.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/inventory_levels.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/inventory_levels/adjust.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/inventory_levels/connect.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/inventory_levels/set.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/inventory_levels.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/inventory_levels/adjust.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/inventory_levels/connect.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/inventory_levels/set.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/inventory_levels.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/inventory_levels/adjust.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/inventory_levels/connect.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/inventory_levels/set.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/inventory_levels.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/inventory_levels/adjust.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/inventory_levels/connect.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/inventory_levels/set.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/inventory_levels.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/inventory_levels/adjust.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/inventory_levels/connect.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/inventory_levels/set.json?{}",
query_);
...
*/
pub async fn deprecated_202001_get_location(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/locations.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-01/locations/{}/json",
...
*/
pub async fn deprecated_202001_get_locations_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/locations/count.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-01/locations/{}/inventory_levels.json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_202004_get_location(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-04/locations.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-04/locations/{}/json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_202004_get_locations_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-04/locations/count.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-04/locations/{}/inventory_levels.json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_202007_get_location(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-07/locations.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-07/locations/{}/json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_202007_get_locations_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-07/locations/count.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-07/locations/{}/inventory_levels.json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
let url =
"/admin/api/2020-10/locations.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-10/locations/{}/json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn get_locations_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-10/locations/count.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2020-10/locations/{}/inventory_levels.json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_202101_get_location(
&self,
) -> Result<()> {
let url =
"/admin/api/2021-01/locations.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2021-01/locations/{}/json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_202101_get_locations_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2021-01/locations/count.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/2021-01/locations/{}/inventory_levels.json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
*/
pub async fn deprecated_unstable_get_location(
&self,
) -> Result<()> {
let url =
"/admin/api/unstable/locations.json".to_string();
self.client.get(&url, None).await
}
...
let url =
format!("/admin/api/unstable/locations/{}/json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
...
let url =
format!("/admin/api/unstable/locations/{}/inventory_levels.json",
crate::progenitor_support::encode_path(&location_id.to_string()),);
