...
&self,
metafield_owner_id: i64, metafield_owner_resource: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if metafield_owner_id > 0 { query_args.push(("metafield[owner_id]".to_string(), metafield_owner_id.to_string())); }
if !metafield_owner_resource.is_empty() { query_args.push(("metafield[owner_resource]".to_string(), metafield_owner_resource.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/metafields.json?{}",
query_);
...
let url =
"/admin/api/2020-01/metafields.json".to_string();
...
let url =
format!("/admin/api/2020-01/metafields/{}/json?{}",
crate::progenitor_support::encode_path(&metafield_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/metafields.json?{}",
query_);
...
let url =
"/admin/api/2020-04/metafields.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/metafields.json?{}",
query_);
...
let url =
"/admin/api/2020-07/metafields.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/metafields.json?{}",
query_);
...
let url =
"/admin/api/2020-10/metafields.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/metafields.json?{}",
query_);
...
let url =
"/admin/api/2021-01/metafields.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/metafields.json?{}",
query_);
...
let url =
"/admin/api/unstable/metafields.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
