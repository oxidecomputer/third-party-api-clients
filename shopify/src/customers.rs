...
impl Customers {
    ...
    pub async fn deprecated_202001_create(
        ...
        let url = self
            .client
            .url("/admin/api/2020-01/customers.json", None);
        self.client
            .post(
                &url,
                crate::Message {
    ...
    */
    ...
    pub async fn deprecated_202004_create(
        ...
        let url = self
            .client
            .url("/admin/api/2020-04/customers.json", None);
        self.client
            .post(
                &url,
                crate::Message {
    ...
    */
    ...
    pub async fn deprecated_202007_create(
        ...
        let url = self
            .client
            .url("/admin/api/2020-07/customers.json", None);
        self.client
            .post(
                &url,
                crate::Message {
    ...
    */
    ...
    pub async fn create(&self, body: &serde_json::Value) -> ClientResult<crate::Response<()>> {
        let url = self
            .client
            .url("/admin/api/2020-10/customers.json", None);
        self.client
            .post(
                &url,
                crate::Message {
    ...
    */
    ...
    pub async fn deprecated_202101_create(
        ...
        let url = self
            .client
            .url("/admin/api/2021-01/customers.json", None);
        self.client
            .post(
                &url,
                crate::Message {
    ...
    */
    ...
    pub async fn deprecated_unstable_create(
        ...
        let url = self
            .client
            .url("/admin/api/unstable/customers.json", None);
        self.client
            .post(
                &url,
                crate::Message {
