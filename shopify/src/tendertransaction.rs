...
&self,
limit: &str, since_id: &str, processed_at_min: &str, processed_at_max: &str, processed_at: &str, order: &str,
) -> Result<()> {
...
if !processed_at.is_empty() { query_args.push(("processed_at".to_string(), processed_at.to_string())); }
...
let url =
format!("/admin/api/2020-01/tender_transactions.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/tender_transactions.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/tender_transactions.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/tender_transactions.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/tender_transactions.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/tender_transactions.json?{}",
query_);
