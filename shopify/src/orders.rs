...
&self,
since_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, status: &str,
) -> Result<()> {
...
let url =
format!("/admin/api/2020-01/checkouts/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/checkouts/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/checkouts/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/checkouts/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/checkouts/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/checkouts/count.json?{}",
query_);
...
&self,
ids: &str, limit: &str, since_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, processed_at_min: &str, processed_at_max: &str, attribution_app_id: &str, status: &str, financial_status: &str, fulfillment_status: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !attribution_app_id.is_empty() { query_args.push(("attribution_app_id".to_string(), attribution_app_id.to_string())); }
if !created_at_max.is_empty() { query_args.push(("created_at_max".to_string(), created_at_max.to_string())); }
if !created_at_min.is_empty() { query_args.push(("created_at_min".to_string(), created_at_min.to_string())); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !financial_status.is_empty() { query_args.push(("financial_status".to_string(), financial_status.to_string())); }
if !fulfillment_status.is_empty() { query_args.push(("fulfillment_status".to_string(), fulfillment_status.to_string())); }
...
if !processed_at_max.is_empty() { query_args.push(("processed_at_max".to_string(), processed_at_max.to_string())); }
if !processed_at_min.is_empty() { query_args.push(("processed_at_min".to_string(), processed_at_min.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
if !status.is_empty() { query_args.push(("status".to_string(), status.to_string())); }
if !updated_at_max.is_empty() { query_args.push(("updated_at_max".to_string(), updated_at_max.to_string())); }
if !updated_at_min.is_empty() { query_args.push(("updated_at_min".to_string(), updated_at_min.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/orders.json?{}",
query_);
...
let url =
"/admin/api/2020-01/orders.json".to_string();
...
&self,
created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, status: &str, financial_status: &str, fulfillment_status: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !created_at_max.is_empty() { query_args.push(("created_at_max".to_string(), created_at_max.to_string())); }
if !created_at_min.is_empty() { query_args.push(("created_at_min".to_string(), created_at_min.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/orders/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/orders/{}/close.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
let url =
format!("/admin/api/2020-01/orders/{}/open.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
&self,
order_id: &str, amount: &str, currency: &str, restock_deprecated: &str, reason: &str, email: &str, refund: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !amount.is_empty() { query_args.push(("amount".to_string(), amount.to_string())); }
if !currency.is_empty() { query_args.push(("currency".to_string(), currency.to_string())); }
if !email.is_empty() { query_args.push(("email".to_string(), email.to_string())); }
if !reason.is_empty() { query_args.push(("reason".to_string(), reason.to_string())); }
if !refund.is_empty() { query_args.push(("refund".to_string(), refund.to_string())); }
if !restock_deprecated.is_empty() { query_args.push(("restock
                  deprecated".to_string(), restock_deprecated.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/orders/{}/cancel.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/orders.json?{}",
query_);
...
let url =
"/admin/api/2020-04/orders.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/orders/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-04/orders/{}/close.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
let url =
format!("/admin/api/2020-04/orders/{}/open.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/orders/{}/cancel.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/orders.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/orders/{}/risks.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
&self,
order_id: &str, risk_id: &str,
) -> Result<()> {
let url =
format!("/admin/api/2020-01/orders/{}/risks/{}/json",
crate::progenitor_support::encode_path(&order_id.to_string()),crate::progenitor_support::encode_path(&risk_id.to_string()),);
...
let url =
format!("/admin/api/2020-04/orders/{}/risks.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
let url =
format!("/admin/api/2020-07/orders/{}/risks.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
* * `order_id: &str` -- storefront_access_token_id.
*/
pub async fn get_param_risk(
&self,
order_id: &str,
) -> Result<()> {
let url =
format!("/admin/api/2020-10/orders/{}/risks.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
let url =
format!("/admin/api/2021-01/orders/{}/risks.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
let url =
format!("/admin/api/unstable/orders/{}/risks.json",
crate::progenitor_support::encode_path(&order_id.to_string()),);
...
&self,
order_id: &str, limit: &str, fields: &str, in_shop_currency: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !in_shop_currency.is_empty() { query_args.push(("in_shop_currency".to_string(), in_shop_currency.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
&self,
order_id: &str, restock_deprecated: &str, notify: &str, note: &str, discrepancy_reason: &str, shipping: &str, refund_line_items: &str, transactions: &str, currency: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !currency.is_empty() { query_args.push(("currency".to_string(), currency.to_string())); }
if !discrepancy_reason.is_empty() { query_args.push(("discrepancy_reason".to_string(), discrepancy_reason.to_string())); }
if !note.is_empty() { query_args.push(("note".to_string(), note.to_string())); }
if !notify.is_empty() { query_args.push(("notify".to_string(), notify.to_string())); }
if !refund_line_items.is_empty() { query_args.push(("refund_line_items".to_string(), refund_line_items.to_string())); }
if !restock_deprecated.is_empty() { query_args.push(("restock
                  deprecated".to_string(), restock_deprecated.to_string())); }
if !shipping.is_empty() { query_args.push(("shipping".to_string(), shipping.to_string())); }
if !transactions.is_empty() { query_args.push(("transactions".to_string(), transactions.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
&self,
order_id: &str, refund_id: &str, fields: &str, in_shop_currency: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !in_shop_currency.is_empty() { query_args.push(("in_shop_currency".to_string(), in_shop_currency.to_string())); }
...
let url =
format!("/admin/api/2020-01/orders/{}/refunds/{}/json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),crate::progenitor_support::encode_path(&refund_id.to_string()),query_);
...
&self,
order_id: &str, shipping: &str, refund_line_items: &str, currency: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !currency.is_empty() { query_args.push(("currency".to_string(), currency.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/orders/{}/refunds/calculate.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/orders/{}/refunds/calculate.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/orders/{}/refunds/calculate.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/orders/{}/refunds/calculate.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/orders/{}/refunds/calculate.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/orders/{}/refunds.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/orders/{}/refunds/calculate.json?{}",
crate::progenitor_support::encode_path(&order_id.to_string()),query_);
