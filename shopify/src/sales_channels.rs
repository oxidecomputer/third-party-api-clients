...
let url =
"/admin/api/2020-01/checkouts.json".to_string();
...
let url =
"/admin/api/2020-04/checkouts.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
"/admin/api/2020-07/checkouts.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
"/admin/api/2020-10/checkouts.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
"/admin/api/2021-01/checkouts.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
"/admin/api/unstable/checkouts.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-01/checkouts/{}/complete.json",
...
let url =
format!("/admin/api/2020-01/checkouts/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-01/checkouts/{}/shipping_rates.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-04/checkouts/{}/complete.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-04/checkouts/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-04/checkouts/{}/shipping_rates.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-07/checkouts/{}/complete.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-07/checkouts/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-07/checkouts/{}/shipping_rates.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-10/checkouts/{}/complete.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-10/checkouts/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-10/checkouts/{}/shipping_rates.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2021-01/checkouts/{}/complete.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2021-01/checkouts/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2021-01/checkouts/{}/shipping_rates.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/unstable/checkouts/{}/complete.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/unstable/checkouts/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/unstable/checkouts/{}/shipping_rates.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-01/collection_listings.json?{}",
query_);
...
&self,
collection_listing_id: &str, limit: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/collection_listings/{}/product_ids.json?{}",
crate::progenitor_support::encode_path(&collection_listing_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/collection_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/collection_listings/{}/product_ids.json?{}",
crate::progenitor_support::encode_path(&collection_listing_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/collection_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/collection_listings/{}/product_ids.json?{}",
crate::progenitor_support::encode_path(&collection_listing_id.to_string()),query_);
...
*                     (default: 50, maximum: 1000).
*/
pub async fn get_collection_listing(
&self,
limit: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/collection_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/collection_listings/{}/product_ids.json?{}",
crate::progenitor_support::encode_path(&collection_listing_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/collection_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/collection_listings/{}/product_ids.json?{}",
crate::progenitor_support::encode_path(&collection_listing_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/collection_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/collection_listings/{}/product_ids.json?{}",
crate::progenitor_support::encode_path(&collection_listing_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-01/checkouts/{}/payments.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
&self,
token: &str, amount_required: &str, request_details_required: &str, session_id_required: &str, unique_token_required: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !amount_required.is_empty() { query_args.push(("amount
                  required".to_string(), amount_required.to_string())); }
if !request_details_required.is_empty() { query_args.push(("request_details
                  required".to_string(), request_details_required.to_string())); }
if !session_id_required.is_empty() { query_args.push(("session_id
                  required".to_string(), session_id_required.to_string())); }
if !unique_token_required.is_empty() { query_args.push(("unique_token
                  required".to_string(), unique_token_required.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/checkouts/{}/payments.json?{}",
crate::progenitor_support::encode_path(&token.to_string()),query_);
...
&self,
token: &str, payment_id: &str,
) -> Result<()> {
let url =
format!("/admin/api/2020-01/checkouts/{}/payments/{}/json",
crate::progenitor_support::encode_path(&token.to_string()),crate::progenitor_support::encode_path(&payment_id.to_string()),);
...
let url =
format!("/admin/api/2020-01/checkouts/{}/payments/count.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-04/checkouts/{}/payments.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-04/checkouts/{}/payments/count.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-07/checkouts/{}/payments.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-07/checkouts/{}/payments/count.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-10/checkouts/{}/payments.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2020-10/checkouts/{}/payments/count.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2021-01/checkouts/{}/payments.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/2021-01/checkouts/{}/payments/count.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/unstable/checkouts/{}/payments.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
let url =
format!("/admin/api/unstable/checkouts/{}/payments/count.json",
crate::progenitor_support::encode_path(&token.to_string()),);
...
&self,
product_ids: &str, limit: &str, collection_id: &str, updated_at_min: &str, handle: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
...
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
if !product_ids.is_empty() { query_args.push(("product_ids".to_string(), product_ids.to_string())); }
if !updated_at_min.is_empty() { query_args.push(("updated_at_min".to_string(), updated_at_min.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/product_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/product_listings/product_ids.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/product_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/product_listings/product_ids.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/product_listings.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/product_listings/product_ids.json?{}",
query_);
