...
*/
pub async fn deprecated_202001_get_balance(
&self,
) -> Result<()> {
let url =
...
*/
pub async fn deprecated_202004_get_balance(
&self,
) -> Result<()> {
let url =
...
*/
pub async fn deprecated_202007_get_balance(
&self,
) -> Result<()> {
let url =
...
*/
pub async fn deprecated_202101_get_balance(
&self,
) -> Result<()> {
let url =
...
*/
pub async fn deprecated_unstable_get_balance(
&self,
) -> Result<()> {
let url =
...
&self,
since_id: &str, last_id: &str, status: &str, initiated_at: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !initiated_at.is_empty() { query_args.push(("initiated_at".to_string(), initiated_at.to_string())); }
if !last_id.is_empty() { query_args.push(("last_id".to_string(), last_id.to_string())); }
...
let url =
format!("/admin/api/2020-01/shopify_payments/disputes.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/shopify_payments/disputes.json?{}",
query_);
...
&self,
since_id: &str, last_id: &str, date_min: &str, date_max: &str, date: &str, status: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !date.is_empty() { query_args.push(("date".to_string(), date.to_string())); }
if !date_max.is_empty() { query_args.push(("date_max".to_string(), date_max.to_string())); }
if !date_min.is_empty() { query_args.push(("date_min".to_string(), date_min.to_string())); }
if !last_id.is_empty() { query_args.push(("last_id".to_string(), last_id.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
if !status.is_empty() { query_args.push(("status".to_string(), status.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/shopify_payments/payouts.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/shopify_payments/payouts.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/shopify_payments/payouts.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/shopify_payments/payouts.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/shopify_payments/payouts.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/shopify_payments/payouts.json?{}",
query_);
...
&self,
since_id: &str, last_id: &str, test: &str, payout_id: &str, payout_status: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !last_id.is_empty() { query_args.push(("last_id".to_string(), last_id.to_string())); }
if !payout_id.is_empty() { query_args.push(("payout_id".to_string(), payout_id.to_string())); }
if !payout_status.is_empty() { query_args.push(("payout_status".to_string(), payout_status.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
if !test.is_empty() { query_args.push(("test".to_string(), test.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/shopify_payments/balance/transactions.json?{}",
query_);
