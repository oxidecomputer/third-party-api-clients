...
&self,
blog_id: &str, limit: &str, since_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str, handle: &str, tag: &str, author: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !author.is_empty() { query_args.push(("author".to_string(), author.to_string())); }
...
if !tag.is_empty() { query_args.push(("tag".to_string(), tag.to_string())); }
...
let url =
format!("/admin/api/2020-01/blogs/{}/articles.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
&self,
blog_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !created_at_max.is_empty() { query_args.push(("created_at_max".to_string(), created_at_max.to_string())); }
if !created_at_min.is_empty() { query_args.push(("created_at_min".to_string(), created_at_min.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/blogs/{}/articles/count.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
&self,
blog_id: &str, article_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/blogs/{}/articles/{}/json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),crate::progenitor_support::encode_path(&article_id.to_string()),query_);
...
&self,
blog_id: &str, article_id: &str,
body: &serde_json::Value
) -> Result<()> {
let url =
format!("/admin/api/2020-01/blogs/{}/articles/{}/json",
crate::progenitor_support::encode_path(&blog_id.to_string()),crate::progenitor_support::encode_path(&article_id.to_string()),);
...
*/
pub async fn deprecated_202001_get_articles_author(
&self,
) -> Result<()> {
let url =
...
&self,
limit: &str, popular: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
if !popular.is_empty() { query_args.push(("popular".to_string(), popular.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/articles/tags.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/blogs/{}/articles.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/blogs/{}/articles/count.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
*/
pub async fn deprecated_202004_get_articles_author(
&self,
) -> Result<()> {
let url =
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/articles/tags.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/blogs/{}/articles.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/blogs/{}/articles/count.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
*/
pub async fn deprecated_202007_get_articles_author(
&self,
) -> Result<()> {
let url =
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/articles/tags.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/blogs/{}/articles.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/blogs/{}/articles/count.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
*/
pub async fn get_articles_author(
&self,
) -> Result<()> {
let url =
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/articles/tags.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/blogs/{}/articles.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/blogs/{}/articles/count.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
*/
pub async fn deprecated_202101_get_articles_author(
&self,
) -> Result<()> {
let url =
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/articles/tags.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/blogs/{}/articles.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/blogs/{}/articles/count.json?{}",
crate::progenitor_support::encode_path(&blog_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/articles/tags.json?{}",
query_);
...
&self,
theme_id: &str, fields: &str, asset_key: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !asset_key.is_empty() { query_args.push(("asset[key]".to_string(), asset_key.to_string())); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
&self,
theme_id: &str, src: &str, source_key: &str,
body: &serde_json::Value
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !source_key.is_empty() { query_args.push(("source_key".to_string(), source_key.to_string())); }
if !src.is_empty() { query_args.push(("src".to_string(), src.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/themes/{}/assets.json?{}",
crate::progenitor_support::encode_path(&theme_id.to_string()),query_);
...
&self,
limit: &str, since_id: &str, handle: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !handle.is_empty() { query_args.push(("handle".to_string(), handle.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/blogs.json?{}",
query_);
...
let url =
"/admin/api/2020-01/blogs.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
*/
pub async fn deprecated_202001_get_blogs_count(
&self,
) -> Result<()> {
let url =
"/admin/api/2020-01/blogs/count.json".to_string();
self.client.get(&url, None).await
}
...
&self,
limit: &str, since_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, fields: &str, published_status: &str, status: &str, article_id: i64, blog_id: i64,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if article_id > 0 { query_args.push(("article_id".to_string(), article_id.to_string())); }
if blog_id > 0 { query_args.push(("blog_id".to_string(), blog_id.to_string())); }
if !created_at_max.is_empty() { query_args.push(("created_at_max".to_string(), created_at_max.to_string())); }
if !created_at_min.is_empty() { query_args.push(("created_at_min".to_string(), created_at_min.to_string())); }
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/comments.json?{}",
query_);
...
let url =
"/admin/api/2020-01/comments.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
&self,
created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, published_at_min: &str, published_at_max: &str, published_status: &str, status: &str, article_id: i64, blog_id: i64,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if article_id > 0 { query_args.push(("article_id".to_string(), article_id.to_string())); }
if blog_id > 0 { query_args.push(("blog_id".to_string(), blog_id.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/comments/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/comments/{}/json?{}",
crate::progenitor_support::encode_path(&comment_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-01/comments/{}/spam.json",
crate::progenitor_support::encode_path(&comment_id.to_string()),);
...
let url =
format!("/admin/api/2020-01/comments/{}/not_spam.json",
crate::progenitor_support::encode_path(&comment_id.to_string()),);
...
let url =
format!("/admin/api/2020-01/comments/{}/approve.json",
crate::progenitor_support::encode_path(&comment_id.to_string()),);
...
let url =
format!("/admin/api/2020-01/comments/{}/remove.json",
crate::progenitor_support::encode_path(&comment_id.to_string()),);
...
let url =
format!("/admin/api/2020-01/comments/{}/restore.json",
crate::progenitor_support::encode_path(&comment_id.to_string()),);
...
&self,
limit: &str, since_id: &str, path: &str, target: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
if !limit.is_empty() { query_args.push(("limit".to_string(), limit.to_string())); }
if !path.is_empty() { query_args.push(("path".to_string(), path.to_string())); }
if !since_id.is_empty() { query_args.push(("since_id".to_string(), since_id.to_string())); }
if !target.is_empty() { query_args.push(("target".to_string(), target.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/redirects.json?{}",
query_);
...
let url =
"/admin/api/2020-01/redirects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/redirects/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/redirects/{}/json?{}",
crate::progenitor_support::encode_path(&redirect_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/redirects.json?{}",
query_);
...
let url =
"/admin/api/2020-04/redirects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/redirects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/redirects.json?{}",
query_);
...
let url =
"/admin/api/2020-07/redirects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/redirects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/redirects.json?{}",
query_);
...
let url =
"/admin/api/2020-10/redirects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/redirects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/redirects.json?{}",
query_);
...
let url =
"/admin/api/2021-01/redirects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/redirects/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/redirects.json?{}",
query_);
...
let url =
"/admin/api/unstable/redirects.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/redirects/count.json?{}",
query_);
...
&self,
limit: &str, since_id: &str, created_at_min: &str, created_at_max: &str, updated_at_min: &str, updated_at_max: &str, src: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !created_at_max.is_empty() { query_args.push(("created_at_max".to_string(), created_at_max.to_string())); }
if !created_at_min.is_empty() { query_args.push(("created_at_min".to_string(), created_at_min.to_string())); }
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/script_tags.json?{}",
query_);
...
let url =
"/admin/api/2020-01/script_tags.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/script_tags/count.json?{}",
query_);
...
let url =
format!("/admin/api/2020-01/script_tags/{}/json?{}",
crate::progenitor_support::encode_path(&script_tag_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/script_tags.json?{}",
query_);
...
let url =
"/admin/api/2020-04/script_tags.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/script_tags/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/script_tags.json?{}",
query_);
...
let url =
"/admin/api/2020-07/script_tags.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/script_tags/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/script_tags.json?{}",
query_);
...
*/
pub async fn create_script_tags(
&self,
body: &serde_json::Value
) -> Result<()> {
let url =
"/admin/api/2020-10/script_tags.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
* * `src: &str` -- Count only script tags with a given URL.
*/
pub async fn get_script_tags_count(
&self,
src: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/script_tags/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/script_tags.json?{}",
query_);
...
let url =
"/admin/api/2021-01/script_tags.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/script_tags/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/script_tags.json?{}",
query_);
...
let url =
"/admin/api/unstable/script_tags.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/script_tags/count.json?{}",
query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/themes.json?{}",
query_);
...
let url =
"/admin/api/2020-01/themes.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/themes.json?{}",
query_);
...
let url =
"/admin/api/2020-04/themes.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/themes.json?{}",
query_);
...
let url =
"/admin/api/2020-07/themes.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/themes.json?{}",
query_);
...
let url =
"/admin/api/2020-10/themes.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/themes.json?{}",
query_);
...
let url =
"/admin/api/2021-01/themes.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/themes.json?{}",
query_);
...
let url =
"/admin/api/unstable/themes.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
