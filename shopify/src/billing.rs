...
let url =
format!("/admin/api/2020-01/application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-01/application_charges.json".to_string();
...
&self,
application_charge_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/application_charges/{}/json?{}",
crate::progenitor_support::encode_path(&application_charge_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-01/application_charges/{}/activate.json",
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-04/application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-04/application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&application_charge_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-07/application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-07/application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&application_charge_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-10/application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-10/application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&application_charge_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/application_charges.json?{}",
query_);
...
let url =
"/admin/api/2021-01/application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/application_charges.json?{}",
query_);
...
let url =
"/admin/api/unstable/application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/application_credits.json?{}",
query_);
...
let url =
"/admin/api/2020-01/application_credits.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
&self,
application_credit_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/application_credits/{}/json?{}",
crate::progenitor_support::encode_path(&application_credit_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/application_credits.json?{}",
query_);
...
let url =
"/admin/api/2020-04/application_credits.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/application_credits.json?{}",
query_);
...
let url =
"/admin/api/2020-07/application_credits.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
* * `fields: &str` -- A comma-separated list of fields to include in the response.
*/
pub async fn get_application_credit(
&self,
fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/application_credits.json?{}",
query_);
...
let url =
"/admin/api/2020-10/application_credits.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/application_credits.json?{}",
query_);
...
let url =
"/admin/api/2021-01/application_credits.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/application_credits.json?{}",
query_);
...
let url =
"/admin/api/unstable/application_credits.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/recurring_application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-01/recurring_application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
&self,
recurring_application_charge_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/recurring_application_charges/{}/json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let url =
format!("/admin/api/2020-01/recurring_application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),);
...
&self,
recurring_application_charge_id: &str, recurring_application_charge_capped_amount: i64,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if recurring_application_charge_capped_amount > 0 { query_args.push(("recurring_application_charge[capped_amount]".to_string(), recurring_application_charge_capped_amount.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/recurring_application_charges/{}/customize.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/recurring_application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-04/recurring_application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-04/recurring_application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/recurring_application_charges/{}/customize.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/recurring_application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-07/recurring_application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-07/recurring_application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/recurring_application_charges/{}/customize.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/recurring_application_charges.json?{}",
query_);
...
let url =
"/admin/api/2020-10/recurring_application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let url =
format!("/admin/api/2020-10/recurring_application_charges/{}/activate.json",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/recurring_application_charges/{}/customize.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/recurring_application_charges.json?{}",
query_);
...
let url =
"/admin/api/2021-01/recurring_application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/recurring_application_charges/{}/customize.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/recurring_application_charges.json?{}",
query_);
...
let url =
"/admin/api/unstable/recurring_application_charges.json".to_string();
self.client.post(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/recurring_application_charges/{}/customize.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/recurring_application_charges/{}/usage_charges.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
&self,
recurring_application_charge_id: &str, usage_charge_id: &str, fields: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !fields.is_empty() { query_args.push(("fields".to_string(), fields.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-01/recurring_application_charges/{}/usage_charges/{}/json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),crate::progenitor_support::encode_path(&usage_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-04/recurring_application_charges/{}/usage_charges.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-07/recurring_application_charges/{}/usage_charges.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2020-10/recurring_application_charges/{}/usage_charges.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/2021-01/recurring_application_charges/{}/usage_charges.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/admin/api/unstable/recurring_application_charges/{}/usage_charges.json?{}",
crate::progenitor_support::encode_path(&recurring_application_charge_id.to_string()),query_);
