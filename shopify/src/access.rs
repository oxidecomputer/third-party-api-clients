...
*/
pub async fn get_admin_oauth_scope(
&self,
) -> Result<()> {
let url =
"/admin/oauth/access_scopes.json".to_string();
...
let url =
format!("/admin/api/2020-01/storefront_access_tokens/{}/json",
...
let url =
format!("/admin/api/2020-04/storefront_access_tokens/{}/json",
crate::progenitor_support::encode_path(&storefront_access_token_id.to_string()),);
...
let url =
format!("/admin/api/2020-07/storefront_access_tokens/{}/json",
crate::progenitor_support::encode_path(&storefront_access_token_id.to_string()),);
...
*/
pub async fn get_storefront_token(
&self,
) -> Result<()> {
let url =
...
let url =
format!("/admin/api/2020-10/storefront_access_tokens/{}/json",
crate::progenitor_support::encode_path(&storefront_access_token_id.to_string()),);
...
let url =
format!("/admin/api/2021-01/storefront_access_tokens/{}/json",
crate::progenitor_support::encode_path(&storefront_access_token_id.to_string()),);
...
let url =
format!("/admin/api/unstable/storefront_access_tokens/{}/json",
crate::progenitor_support::encode_path(&storefront_access_token_id.to_string()),);
