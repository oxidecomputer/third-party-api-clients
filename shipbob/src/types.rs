...
pub fulfillable_quantity_by_fulfillment_center: Vec<ShipbobInventoryApiViewModelsFulfillmentCenterQuantityModel>,
/**
* Break down of fulfillable quantity by lot
*/
#[serde(default,
...
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
EstimatedFulfillmentDateStatus::AwaitingInventoryAllocation => "AwaitingInventoryAllocation",
...
ShipBobOrdersPresentationViewModelsOrderModelStatus::PartiallyFulfilled => "PartiallyFulfilled",
...
impl ShipBobOrdersPresentationViewModelsOrderModelStatus {
            pub fn is_noop(&self) -> bool {
                matches!(self, ShipBobOrdersPresentationViewModelsOrderModelStatus::Noop)
            }
    }
...
impl ShipBobOrdersPresentationViewModelsOrderModelType {
            pub fn is_noop(&self) -> bool {
                matches!(self, ShipBobOrdersPresentationViewModelsOrderModelType::Noop)
            }
    }
...
ShipBobOrdersPresentationModelsAddProductOrderByModel(ShipBobOrdersPresentationModelsAddProductOrderByModel),
ShipBobOrdersPresentationModelsAddProductOrderByReferenceModel(ShipBobOrdersPresentationModelsAddProductOrderByReferenceModel),
}

impl ShipBobOrdersPresentationModelsAddProductOrderModelOneOf {
pub fn ship_bob_orders_presentation_models_add_product_order_by_model(&self) -> Option<&ShipBobOrdersPresentationModelsAddProductOrderByModel> {
...
pub fn ship_bob_orders_presentation_models_add_product_order_by_reference_model(&self) -> Option<&ShipBobOrdersPresentationModelsAddProductOrderByReferenceModel> {
...
ShipBobOrdersPresentationViewModelsCanceledOrderModelStatus::PartialSuccess => "PartialSuccess",
...
impl ShipBobOrdersPresentationViewModelsCanceledOrderModelStatus {
            pub fn is_noop(&self) -> bool {
                matches!(self, ShipBobOrdersPresentationViewModelsCanceledOrderModelStatus::Noop)
            }
    }
...
pub fulfillable_quantity_by_fulfillment_center: Vec<ShipbobProductsApiViewModelsPublicFulfillmentCenterQuantityModel>,
/**
* Name of the channel
*/
#[serde(default,
...
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
ShipbobReceivingPublicCommonModelsPackageType::FloorLoadedContainer => "FloorLoadedContainer",
...
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
ShipbobReceivingPublicCommonModelsPackingType::EverythingInOneBox => "EverythingInOneBox",
...
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
ShipbobReturnsPublicCommonTransactionLogSource::ReturnLabelInvoice => "ReturnLabelInvoice",
ShipbobReturnsPublicCommonTransactionLogSource::ReturnProcessingFee => "ReturnProcessingFee",
ShipbobReturnsPublicCommonTransactionLogSource::ReturnToSenderFee => "ReturnToSenderFee",
...
#[derive(Serialize, Deserialize, PartialEq, Debug, Clone, JsonSchema)]
pub enum ShipbobReturnsPublicCommonSortOrder {
#[serde(rename = "Newest")]
Newest,
#[serde(rename = "Oldest")]
Oldest,
...
impl std::fmt::Display for ShipbobReturnsPublicCommonSortOrder {
fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
match &*self {
ShipbobReturnsPublicCommonSortOrder::Newest => "Newest",
ShipbobReturnsPublicCommonSortOrder::Oldest => "Oldest",
ShipbobReturnsPublicCommonSortOrder::Noop => "",
ShipbobReturnsPublicCommonSortOrder::FallthroughString => "*",
}
.fmt(f)
}
}

impl Default for ShipbobReturnsPublicCommonSortOrder {
fn default() -> ShipbobReturnsPublicCommonSortOrder {
ShipbobReturnsPublicCommonSortOrder::Noop
}
}
impl ShipbobReturnsPublicCommonSortOrder {
            pub fn is_noop(&self) -> bool {
                matches!(self, ShipbobReturnsPublicCommonSortOrder::Noop)
            }
    }
...
#[serde(flatten)]
pub integrations_location_public_api_view_models_model: IntegrationsLocationPublicApiViewModelsModel,
#[serde(flatten)]
pub integrations_location_public_api_view_models_internal_model: IntegrationsLocationPublicApiViewModelsInternalModel,
}
