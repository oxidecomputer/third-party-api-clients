...
let url =
format!("/admin/directory/v1/customer/{}/resources/buildings?{}",
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, coordinates_source: crate::types::CoordinatesSource,
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, building_id: &str,
) -> Result<crate::types::Building> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
let url =
format!("/admin/directory/v1/customer/{}/resources/buildings/{}?{}",
crate::progenitor_support::encode_path(&customer.to_string()),crate::progenitor_support::encode_path(&building_id.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, building_id: &str, coordinates_source: crate::types::CoordinatesSource,
body: &crate::types::Building
) -> Result<crate::types::Building> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, max_results: i64, order_by: &str, page_token: &str, query: &str,
...
let url =
format!("/admin/directory/v1/customer/{}/resources/calendars?{}",
crate::progenitor_support::encode_path(&customer.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, calendar_resource_id: &str,
) -> Result<crate::types::CalendarResource> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
let url =
format!("/admin/directory/v1/customer/{}/resources/calendars/{}?{}",
crate::progenitor_support::encode_path(&customer.to_string()),crate::progenitor_support::encode_path(&calendar_resource_id.to_string()),query);
...
let url =
format!("/admin/directory/v1/customer/{}/resources/features?{}",
crate::progenitor_support::encode_path(&customer.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, feature_key: &str,
) -> Result<crate::types::Feature> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
let url =
format!("/admin/directory/v1/customer/{}/resources/features/{}?{}",
crate::progenitor_support::encode_path(&customer.to_string()),crate::progenitor_support::encode_path(&feature_key.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, old_name: &str,
...
let url =
format!("/admin/directory/v1/customer/{}/resources/features/{}/rename?{}",
crate::progenitor_support::encode_path(&customer.to_string()),crate::progenitor_support::encode_path(&old_name.to_string()),query);
