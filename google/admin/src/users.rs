...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, custom_field_mask: &str, customer: &str, domain: &str, event: crate::types::Event, max_results: i64, order_by: crate::types::DirectoryUsersListOrderBy, page_token: &str, projection: crate::types::DirectoryUsersListProjection, query: &str, show_deleted: &str, sort_order: crate::types::SortOrder, view_type: crate::types::ViewType,
...
if !custom_field_mask.is_empty() { query_args.push(format!("custom_field_mask={}", custom_field_mask)); }
if !customer.is_empty() { query_args.push(format!("customer={}", customer)); }
if !domain.is_empty() { query_args.push(format!("domain={}", domain)); }
...
if !show_deleted.is_empty() { query_args.push(format!("show_deleted={}", show_deleted)); }
...
let url =
format!("/admin/directory/v1/users?{}",
query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str,
...
let url =
format!("/admin/directory/v1/users/watch?{}",
query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, user_key: &str, custom_field_mask: &str, projection: crate::types::DirectoryUsersListProjection, view_type: crate::types::ViewType,
) -> Result<crate::types::User> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, user_key: &str, event: crate::types::DirectoryUsersAliasesListEvent,
...
let url =
format!("/admin/directory/v1/users/{}/aliases?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
...
let url =
format!("/admin/directory/v1/users/{}/aliases/watch?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, user_key: &str, alias: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
let url =
format!("/admin/directory/v1/users/{}/aliases/{}?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),crate::progenitor_support::encode_path(&alias.to_string()),query);
...
let url =
format!("/admin/directory/v1/users/{}/makeAdmin?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
...
let url =
format!("/admin/directory/v1/users/{}/photos/thumbnail?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
...
let url =
format!("/admin/directory/v1/users/{}/signOut?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
...
let url =
format!("/admin/directory/v1/users/{}/undelete?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
