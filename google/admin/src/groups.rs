...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer: &str, domain: &str, max_results: i64, order_by: crate::types::DirectoryGroupsListOrderBy, page_token: &str, query: &str, sort_order: crate::types::SortOrder, user_key: &str,
...
if !user_key.is_empty() { query_args.push(format!("user_key={}", user_key)); }
...
let url =
format!("/admin/directory/v1/groups?{}",
query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, group_key: &str,
) -> Result<crate::types::Group> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
let url =
format!("/admin/directory/v1/groups/{}?{}",
crate::progenitor_support::encode_path(&group_key.to_string()),query);
...
let url =
format!("/admin/directory/v1/groups/{}/aliases?{}",
crate::progenitor_support::encode_path(&group_key.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, group_key: &str, alias: &str,
) -> Result<()> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !access_token.is_empty() { query_args.push(format!("access_token={}", access_token)); }
...
let url =
format!("/admin/directory/v1/groups/{}/aliases/{}?{}",
crate::progenitor_support::encode_path(&group_key.to_string()),crate::progenitor_support::encode_path(&alias.to_string()),query);
