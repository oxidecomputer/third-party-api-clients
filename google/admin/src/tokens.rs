...
let url =
format!("/admin/directory/v1/users/{}/tokens?{}",
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, user_key: &str, client_id: &str,
...
let url =
format!("/admin/directory/v1/users/{}/tokens/{}?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),crate::progenitor_support::encode_path(&client_id.to_string()),query);
