...
let url =
format!("/admin/directory/v1/users/{}/verificationCodes?{}",
...
let url =
format!("/admin/directory/v1/users/{}/verificationCodes/generate?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
...
let url =
format!("/admin/directory/v1/users/{}/verificationCodes/invalidate?{}",
crate::progenitor_support::encode_path(&user_key.to_string()),query);
