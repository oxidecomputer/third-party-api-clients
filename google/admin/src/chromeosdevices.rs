...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer_id: &str, max_results: i64, order_by: crate::types::OrderBy, org_unit_path: &str, page_token: &str, projection: crate::types::Projection, query: &str, sort_order: crate::types::SortOrder,
...
let url =
format!("/admin/directory/v1/customer/{}/devices/chromeos?{}",
...
let url =
format!("/admin/directory/v1/customer/{}/devices/chromeos/moveDevicesToOu?{}",
crate::progenitor_support::encode_path(&customer_id.to_string()),query);
...
&self,
xgafv: crate::types::Xgafv, access_token: &str, alt: crate::types::Alt, callback: &str, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, upload_protocol: &str, upload_type: &str, customer_id: &str, device_id: &str, projection: crate::types::Projection,
...
let url =
format!("/admin/directory/v1/customer/{}/devices/chromeos/{}/action?{}",
