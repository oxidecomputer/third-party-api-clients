...
* * `show_deleted: bool` -- Whether to include deleted calendar list entries in the result. Optional. The default is False.
* * `show_hidden: bool` -- Whether to show hidden entries. Optional. The default is False.
...
pub async fn get(
&self,
alt: crate::types::Alt, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, user_ip: &str, max_results: i64, min_access_role: crate::types::MinAccessRole, page_token: &str, show_deleted: bool, show_hidden: bool, sync_token: &str,
...
if show_hidden { query_args.push(format!("show_hidden={}", show_hidden)); }
...
pub async fn insert(
&self,
alt: crate::types::Alt, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, user_ip: &str, color_rgb_format: bool,
body: &crate::types::CalendarListEntry
) -> Result<crate::types::CalendarListEntry> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("alt={}", alt));
if color_rgb_format { query_args.push(format!("color_rgb_format={}", color_rgb_format)); }
if !fields.is_empty() { query_args.push(format!("fields={}", fields)); }
if !key.is_empty() { query_args.push(format!("key={}", key)); }
if !oauth_token.is_empty() { query_args.push(format!("oauth_token={}", oauth_token)); }
if pretty_print { query_args.push(format!("pretty_print={}", pretty_print)); }
...
let url =
format!("/users/me/calendarList/watch?{}",
query);
...
pub async fn get(
&self,
alt: crate::types::Alt, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, user_ip: &str, calendar_id: &str,
) -> Result<crate::types::CalendarListEntry> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("alt={}", alt));
...
pub async fn update(
&self,
alt: crate::types::Alt, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, user_ip: &str, calendar_id: &str, color_rgb_format: bool,
body: &crate::types::CalendarListEntry
) -> Result<crate::types::CalendarListEntry> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
