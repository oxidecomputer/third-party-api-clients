...
&self,
alt: crate::types::Alt, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, user_ip: &str, max_results: i64, page_token: &str, sync_token: &str,
...
let url =
format!("/users/me/settings/watch?{}",
query);
...
&self,
alt: crate::types::Alt, fields: &str, key: &str, oauth_token: &str, pretty_print: bool, quota_user: &str, user_ip: &str, setting: &str,
...
let url =
format!("/users/me/settings/{}?{}",
crate::progenitor_support::encode_path(&setting.to_string()),query);
