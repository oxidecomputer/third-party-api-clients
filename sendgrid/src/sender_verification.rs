...
impl SenderVerification {
    ...
    pub async fn get_verified_senders(
        ...
        last_seen_id: f64,
        id: i64,
    ) -> ClientResult<crate::Response<crate::types::GetVerifiedSendersResponse>> {
     ...
     */
    pub async fn get_verified_senders_verify_token(
        &self,
        token: &str,
     ...
     */
    pub async fn delete_verified_senders(
        &self,
        id: &str,
     ...
     */
    pub async fn post_verified_senders_resend(
        &self,
        id: &str,
    ) -> ClientResult<crate::Response<crate::types::Help>> {
        let url = self.client.url(
