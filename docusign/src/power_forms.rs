...
&self,
account_id: &str, from_date: &str, order: &str, order_by: &str, to_date: &str,
...
let url =
format!("/v2.1/accounts/{}/powerforms?{}",
...
&self,
account_id: &str, start_position: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/powerforms/senders?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
&self,
account_id: &str, power_form_id: &str,
) -> Result<crate::types::PowerForm> {
let url =
format!("/v2.1/accounts/{}/powerforms/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&power_form_id.to_string()),);
