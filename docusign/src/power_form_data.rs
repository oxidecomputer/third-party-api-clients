...
if !data_layout.is_empty() { query_args.push(format!("data_layout={}", data_layout)); }
...
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&power_form_id.to_string()),query);
