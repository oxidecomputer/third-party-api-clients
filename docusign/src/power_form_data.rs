...
&self,
account_id: &str, power_form_id: &str, data_layout: &str, from_date: &str, to_date: &str,
) -> Result<crate::types::PowerFormsFormDataResponse> {
let mut query_args: Vec<(String, String)> = Default::default();
if !data_layout.is_empty() { query_args.push(("data_layout".to_string(), data_layout.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/powerforms/{}/form_data?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&power_form_id.to_string()),query_);
