...
let url =
format!("/v2.1/accounts/{}/envelopes/transfer_rules?{}",
...
&self,
account_id: &str, envelope_transfer_rule_id: &str,
body: &crate::types::EnvelopeTransferRule
) -> Result<crate::types::EnvelopeTransferRule> {
let url =
format!("/v2.1/accounts/{}/envelopes/transfer_rules/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_transfer_rule_id.to_string()),);
