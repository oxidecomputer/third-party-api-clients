...
&self,
account_id: &str, custom_tab_only: &str,
) -> Result<crate::types::TabMetadataList> {
let mut query_args: Vec<(String, String)> = Default::default();
if !custom_tab_only.is_empty() { query_args.push(("custom_tab_only".to_string(), custom_tab_only.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/tab_definitions?{}",
...
&self,
account_id: &str, custom_tab_id: &str,
) -> Result<crate::types::TabMetadata> {
let url =
format!("/v2.1/accounts/{}/tab_definitions/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&custom_tab_id.to_string()),);
