...
pub async fn get(
&self,
account_id: &str, user_id: &str, stamp_type: &str,
) -> Result<crate::types::UserSignaturesInformation> {
let mut query_args: Vec<(String, String)> = Default::default();
if !stamp_type.is_empty() { query_args.push(("stamp_type".to_string(), stamp_type.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users/{}/signatures?{}",
...
&self,
account_id: &str, signature_id: &str, user_id: &str,
) -> Result<crate::types::UserSignature> {
let url =
format!("/v2.1/accounts/{}/users/{}/signatures/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),);
...
&self,
account_id: &str, signature_id: &str, user_id: &str, close_existing_signature: &str,
body: &crate::types::UserSignatureDefinition
) -> Result<crate::types::UserSignature> {
let mut query_args: Vec<(String, String)> = Default::default();
if !close_existing_signature.is_empty() { query_args.push(("close_existing_signature".to_string(), close_existing_signature.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users/{}/signatures/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),query_);
...
&self,
account_id: &str, image_type: &str, signature_id: &str, user_id: &str, include_chrome: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
...
let url =
format!("/v2.1/accounts/{}/users/{}/signatures/{}/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),crate::progenitor_support::encode_path(&image_type.to_string()),query_);
...
&self,
account_id: &str, image_type: &str, signature_id: &str, user_id: &str, transparent_png: &str,
) -> Result<crate::types::UserSignature> {
let mut query_args: Vec<(String, String)> = Default::default();
if !transparent_png.is_empty() { query_args.push(("transparent_png".to_string(), transparent_png.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users/{}/signatures/{}/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),crate::progenitor_support::encode_path(&image_type.to_string()),query_);
...
&self,
account_id: &str, image_type: &str, signature_id: &str, user_id: &str,
) -> Result<crate::types::UserSignature> {
let url =
format!("/v2.1/accounts/{}/users/{}/signatures/{}/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),crate::progenitor_support::encode_path(&image_type.to_string()),);
