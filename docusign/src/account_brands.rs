...
&self,
account_id: &str, exclude_distributor_brand: &str, include_logos: &str,
) -> Result<crate::types::AccountBrands> {
let mut query_args: Vec<(String, String)> = Default::default();
if !exclude_distributor_brand.is_empty() { query_args.push(("exclude_distributor_brand".to_string(), exclude_distributor_brand.to_string())); }
if !include_logos.is_empty() { query_args.push(("include_logos".to_string(), include_logos.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/brands?{}",
...
&self,
account_id: &str, brand_id: &str, include_external_references: &str, include_logos: &str,
) -> Result<crate::types::Brand> {
let mut query_args: Vec<(String, String)> = Default::default();
if !include_external_references.is_empty() { query_args.push(("include_external_references".to_string(), include_external_references.to_string())); }
if !include_logos.is_empty() { query_args.push(("include_logos".to_string(), include_logos.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/brands/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),query_);
...
&self,
account_id: &str, brand_id: &str,
body: &crate::types::Brand
) -> Result<crate::types::Brand> {
let url =
format!("/v2.1/accounts/{}/brands/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/brands/{}/file",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),);
...
&self,
account_id: &str, brand_id: &str, logo_type: &str,
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/brands/{}/logos/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),crate::progenitor_support::encode_path(&logo_type.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/brands/{}/resources",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),);
...
&self,
account_id: &str, brand_id: &str, resource_content_type: &str, langcode: &str, return_master: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !langcode.is_empty() { query_args.push(("langcode".to_string(), langcode.to_string())); }
if !return_master.is_empty() { query_args.push(("return_master".to_string(), return_master.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/brands/{}/resources/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),crate::progenitor_support::encode_path(&resource_content_type.to_string()),query_);
...
&self,
account_id: &str, brand_id: &str, resource_content_type: &str,
) -> Result<crate::types::BrandResources> {
let url =
format!("/v2.1/accounts/{}/brands/{}/resources/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&brand_id.to_string()),crate::progenitor_support::encode_path(&resource_content_type.to_string()),);
