...
let url =
format!("/v2.1/accounts/{}/billing_payments?{}",
...
&self,
account_id: &str, payment_id: &str,
) -> Result<crate::types::BillingPaymentItem> {
let url =
format!("/v2.1/accounts/{}/billing_payments/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&payment_id.to_string()),);
