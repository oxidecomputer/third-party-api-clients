...
if !lang_code.is_empty() { query_args.push(format!("lang_code={}", lang_code)); }
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/recipients/{}/consumer_disclosure/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&recipient_id.to_string()),crate::progenitor_support::encode_path(&lang_code.to_string()),query);
