...
&self,
account_id: &str, envelope_id: &str, include_anchor_tab_locations: &str, include_extended: &str, include_metadata: &str, include_tabs: &str,
) -> Result<crate::types::EnvelopeRecipients> {
let mut query_args: Vec<(String, String)> = Default::default();
if !include_anchor_tab_locations.is_empty() { query_args.push(("include_anchor_tab_locations".to_string(), include_anchor_tab_locations.to_string())); }
if !include_extended.is_empty() { query_args.push(("include_extended".to_string(), include_extended.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/recipients?{}",
...
&self,
account_id: &str, envelope_id: &str, combine_same_order_recipients: &str, offline_signing: &str, resend_envelope: &str,
body: &crate::types::EnvelopeRecipients
) -> Result<crate::types::RecipientsUpdateSummary> {
let mut query_args: Vec<(String, String)> = Default::default();
if !combine_same_order_recipients.is_empty() { query_args.push(("combine_same_order_recipients".to_string(), combine_same_order_recipients.to_string())); }
if !offline_signing.is_empty() { query_args.push(("offline_signing".to_string(), offline_signing.to_string())); }
...
&self,
account_id: &str, envelope_id: &str, resend_envelope: &str,
body: &crate::types::EnvelopeRecipients
) -> Result<crate::types::EnvelopeRecipients> {
let mut query_args: Vec<(String, String)> = Default::default();
if !resend_envelope.is_empty() { query_args.push(("resend_envelope".to_string(), resend_envelope.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/recipients/{}/identity_proof_token",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&recipient_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/recipients/{}/views/identity_manual_review",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&recipient_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/views/recipient_preview",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
