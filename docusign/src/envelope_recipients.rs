...
if !include_anchor_tab_locations.is_empty() { query_args.push(format!("include_anchor_tab_locations={}", include_anchor_tab_locations)); }
if !include_extended.is_empty() { query_args.push(format!("include_extended={}", include_extended)); }
...
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !combine_same_order_recipients.is_empty() { query_args.push(format!("combine_same_order_recipients={}", combine_same_order_recipients)); }
if !offline_signing.is_empty() { query_args.push(format!("offline_signing={}", offline_signing)); }
