...
&self,
) -> Result<crate::types::ProvisioningInformation> {
let url =
"/v2.1/accounts/provisioning".to_string();
...
pub async fn get(
&self,
account_id: &str, include_account_settings: &str,
) -> Result<crate::types::AccountInformation> {
let mut query_args: Vec<(String, String)> = Default::default();
if !include_account_settings.is_empty() { query_args.push(("include_account_settings".to_string(), include_account_settings.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}?{}",
...
&self,
account_id: &str, include_charges: &str,
) -> Result<crate::types::BillingChargeResponse> {
let mut query_args: Vec<(String, String)> = Default::default();
if !include_charges.is_empty() { query_args.push(("include_charges".to_string(), include_charges.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/billing_charges?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
&self,
account_id: &str, recipient_part: &str,
body: &crate::types::CaptiveRecipientInformation
) -> Result<crate::types::CaptiveRecipientInformation> {
let url =
format!("/v2.1/accounts/{}/captive_recipients/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&recipient_part.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/recipient_names?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
let url =
format!("/v2.1/accounts/{}/settings/envelope_purge_configuration",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/settings/notification_defaults",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
&self,
account_id: &str, count: &str, envelopes_not_shared_user_status: &str, folder_ids: &str, item_type: &str, search_text: &str, shared: &str, start_position: &str, user_ids: &str,
) -> Result<crate::types::AccountSharedAccess> {
let mut query_args: Vec<(String, String)> = Default::default();
if !count.is_empty() { query_args.push(("count".to_string(), count.to_string())); }
if !envelopes_not_shared_user_status.is_empty() { query_args.push(("envelopes_not_shared_user_status".to_string(), envelopes_not_shared_user_status.to_string())); }
if !folder_ids.is_empty() { query_args.push(("folder_ids".to_string(), folder_ids.to_string())); }
if !item_type.is_empty() { query_args.push(("item_type".to_string(), item_type.to_string())); }
if !search_text.is_empty() { query_args.push(("search_text".to_string(), search_text.to_string())); }
if !shared.is_empty() { query_args.push(("shared".to_string(), shared.to_string())); }
if !start_position.is_empty() { query_args.push(("start_position".to_string(), start_position.to_string())); }
if !user_ids.is_empty() { query_args.push(("user_ids".to_string(), user_ids.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/shared_access?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
&self,
account_id: &str, item_type: &str, preserve_existing_shared_access: &str, user_ids: &str,
body: &crate::types::AccountSharedAccess
) -> Result<crate::types::AccountSharedAccess> {
let mut query_args: Vec<(String, String)> = Default::default();
if !item_type.is_empty() { query_args.push(("item_type".to_string(), item_type.to_string())); }
if !preserve_existing_shared_access.is_empty() { query_args.push(("preserve_existing_shared_access".to_string(), preserve_existing_shared_access.to_string())); }
if !user_ids.is_empty() { query_args.push(("user_ids".to_string(), user_ids.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/shared_access?{}",
...
let url =
format!("/v2.1/accounts/{}/supported_languages",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/unsupported_file_types",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
&self,
organization_id: &str, result_id: &str,
) -> Result<()> {
let url =
format!("/v2.1/organization_exports/{}/account_settings/{}",
crate::progenitor_support::encode_path(&organization_id.to_string()),crate::progenitor_support::encode_path(&result_id.to_string()),);
