...
pub async fn get(
&self,
account_id: &str, additional_info: &str, count: &str, email: &str, email_substring: &str, group_id: &str, include_usersettings_for_csv: &str, login_status: &str, not_group_id: &str, start_position: &str, status: &str, user_name_substring: &str,
) -> Result<crate::types::UserInformationList> {
let mut query_args: Vec<(String, String)> = Default::default();
if !additional_info.is_empty() { query_args.push(("additional_info".to_string(), additional_info.to_string())); }
...
if !email_substring.is_empty() { query_args.push(("email_substring".to_string(), email_substring.to_string())); }
if !group_id.is_empty() { query_args.push(("group_id".to_string(), group_id.to_string())); }
if !include_usersettings_for_csv.is_empty() { query_args.push(("include_usersettings_for_csv".to_string(), include_usersettings_for_csv.to_string())); }
if !login_status.is_empty() { query_args.push(("login_status".to_string(), login_status.to_string())); }
if !not_group_id.is_empty() { query_args.push(("not_group_id".to_string(), not_group_id.to_string())); }
...
if !user_name_substring.is_empty() { query_args.push(("user_name_substring".to_string(), user_name_substring.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users?{}",
...
pub async fn delete(
&self,
account_id: &str, delete: &str,
body: &crate::types::UserInfoList
) -> Result<crate::types::UsersResponse> {
let mut query_args: Vec<(String, String)> = Default::default();
if !delete.is_empty() { query_args.push(("delete".to_string(), delete.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
&self,
account_id: &str, user_id: &str, additional_info: &str, email: &str,
...
let url =
format!("/v2.1/accounts/{}/users/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),query_);
...
&self,
account_id: &str, user_id: &str, encoding: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !encoding.is_empty() { query_args.push(("encoding".to_string(), encoding.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users/{}/profile/image?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),query_);
...
let url =
format!("/v2.1/accounts/{}/users/{}/settings",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),);
