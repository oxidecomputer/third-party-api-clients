...
let url =
format!("/v2.1/accounts/{}/templates/{}/documents/{}/pages/{}/tabs",
...
&self,
account_id: &str, document_id: &str, template_id: &str, page_numbers: &str,
) -> Result<crate::types::TemplateDocumentTabs> {
let mut query_args: Vec<(String, String)> = Default::default();
if !page_numbers.is_empty() { query_args.push(("page_numbers".to_string(), page_numbers.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/templates/{}/documents/{}/tabs?{}",
