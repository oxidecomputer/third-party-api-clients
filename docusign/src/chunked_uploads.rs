...
let url =
format!("/v2.1/accounts/{}/chunked_uploads",
...
&self,
account_id: &str, chunked_upload_id: &str, include: &str,
) -> Result<crate::types::ChunkedUploadResponse> {
...
let url =
format!("/v2.1/accounts/{}/chunked_uploads/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&chunked_upload_id.to_string()),query_);
...
pub async fn put(
&self,
account_id: &str, chunked_upload_id: &str, action: &str,
) -> Result<crate::types::ChunkedUploadResponse> {
let mut query_args: Vec<(String, String)> = Default::default();
if !action.is_empty() { query_args.push(("action".to_string(), action.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/chunked_uploads/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&chunked_upload_id.to_string()),query_);
...
&self,
account_id: &str, chunked_upload_id: &str,
) -> Result<crate::types::ChunkedUploadResponse> {
let url =
format!("/v2.1/accounts/{}/chunked_uploads/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&chunked_upload_id.to_string()),);
...
&self,
account_id: &str, chunked_upload_id: &str, chunked_upload_part_seq: &str,
body: &crate::types::ChunkedUploadRequest
) -> Result<crate::types::ChunkedUploadResponse> {
let url =
format!("/v2.1/accounts/{}/chunked_uploads/{}/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&chunked_upload_id.to_string()),crate::progenitor_support::encode_path(&chunked_upload_part_seq.to_string()),);
