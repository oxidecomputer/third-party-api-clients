...
let url =
format!("/v2.1/accounts/{}/consumer_disclosure?{}",
...
let url =
format!("/v2.1/accounts/{}/consumer_disclosure/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&lang_code.to_string()),);
...
&self,
account_id: &str, lang_code: &str, include_metadata: &str,
...
let url =
format!("/v2.1/accounts/{}/consumer_disclosure/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&lang_code.to_string()),query_);
