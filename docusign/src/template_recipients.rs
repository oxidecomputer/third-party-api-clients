...
&self,
account_id: &str, template_id: &str, include_anchor_tab_locations: &str, include_extended: &str, include_tabs: &str,
...
let url =
format!("/v2.1/accounts/{}/templates/{}/recipients?{}",
...
&self,
account_id: &str, template_id: &str, resend_envelope: &str,
...
&self,
account_id: &str, recipient_id: &str, template_id: &str,
body: &crate::types::TemplateRecipientsData
) -> Result<crate::types::Recipients> {
let url =
format!("/v2.1/accounts/{}/templates/{}/recipients/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),crate::progenitor_support::encode_path(&recipient_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/templates/{}/views/recipient_preview",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),);
