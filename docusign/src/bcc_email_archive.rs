...
&self,
account_id: &str, count: &str, start_position: &str,
...
let url =
format!("/v2.1/accounts/{}/settings/bcc_email_archives?{}",
...
&self,
account_id: &str, bcc_email_archive_id: &str, count: &str, start_position: &str,
...
let url =
format!("/v2.1/accounts/{}/settings/bcc_email_archives/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&bcc_email_archive_id.to_string()),query_);
...
pub async fn delete(
&self,
account_id: &str, bcc_email_archive_id: &str,
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/settings/bcc_email_archives/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&bcc_email_archive_id.to_string()),);
