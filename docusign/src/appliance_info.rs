...
&self,
account_id: &str,
) -> Result<crate::types::DssValues> {
let url =
format!("/v2.1/accounts/{}/display_appliance_info/dynamicsystemsettings",
...
let url =
format!("/v2.1/accounts/{}/display_appliance_info/templateInfo",
crate::progenitor_support::encode_path(&account_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info",
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/account_info",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/custom_fields",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/custom_fields/delete",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/date_signed",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/document/{}",
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/document_page_list",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/image",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
&self,
account_id: &str, envelope_id: &str, user_id: &str,
) -> Result<crate::types::DssValues> {
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/localepolicy/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/page_info",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/page_info/delete",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/pdf",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
&self,
account_id: &str, envelope_id: &str, pdf_id: &str,
) -> Result<crate::types::DssValues> {
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/pdf/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&pdf_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/pdf_blobs",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/recipient_denied_copy",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/display_appliance_info/signer_attachment_info",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),);
...
* 
*/
pub async fn envelope_post_error(
&self,
) -> Result<()> {
let url =
"/v2.1/display_appliance_info/error".to_string();
self.client.post(&url, None).await
}
...
let url =
"/v2.1/display_appliance_info/redeem".to_string();
self.client.post(&url, None).await
}
