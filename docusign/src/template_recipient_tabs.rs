...
&self,
account_id: &str, recipient_id: &str, template_id: &str, include_anchor_tab_locations: &str, include_metadata: &str,
...
let url =
format!("/v2.1/accounts/{}/templates/{}/recipients/{}/tabs?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),crate::progenitor_support::encode_path(&recipient_id.to_string()),query_);
