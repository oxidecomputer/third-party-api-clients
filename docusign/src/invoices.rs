...
let url =
format!("/v2.1/accounts/{}/billing_invoices?{}",
...
&self,
account_id: &str, invoice_id: &str,
) -> Result<crate::types::BillingInvoice> {
let url =
format!("/v2.1/accounts/{}/billing_invoices/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&invoice_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/billing_invoices_past_due",
