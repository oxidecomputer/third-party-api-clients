...
&self,
account_id: &str, user_id: &str, redirect_url: &str,
) -> Result<crate::types::CloudStorageProvidersData> {
let mut query_args: Vec<(String, String)> = Default::default();
if !redirect_url.is_empty() { query_args.push(("redirectUrl".to_string(), redirect_url.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/users/{}/cloud_storage?{}",
...
&self,
account_id: &str, service_id: &str, user_id: &str, redirect_url: &str,
) -> Result<crate::types::CloudStorageProvidersData> {
let mut query_args: Vec<(String, String)> = Default::default();
if !redirect_url.is_empty() { query_args.push(("redirectUrl".to_string(), redirect_url.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
...
&self,
account_id: &str, service_id: &str, user_id: &str,
) -> Result<crate::types::CloudStorageProvidersData> {
let url =
format!("/v2.1/accounts/{}/users/{}/cloud_storage/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&user_id.to_string()),crate::progenitor_support::encode_path(&service_id.to_string()),);
