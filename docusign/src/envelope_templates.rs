...
&self,
account_id: &str, document_id: &str, envelope_id: &str, include: &str,
...
let url =
format!("/v2.1/accounts/{}/envelopes/{}/documents/{}/templates?{}",
...
&self,
account_id: &str, document_id: &str, envelope_id: &str, preserve_template_recipient: &str,
body: &crate::types::DocumentTemplateList
) -> Result<crate::types::DocumentTemplateList> {
let mut query_args: Vec<(String, String)> = Default::default();
if !preserve_template_recipient.is_empty() { query_args.push(("preserve_template_recipient".to_string(), preserve_template_recipient.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/envelopes/{}/documents/{}/templates?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&document_id.to_string()),query_);
...
&self,
account_id: &str, document_id: &str, envelope_id: &str, template_id: &str,
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/envelopes/{}/documents/{}/templates/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&envelope_id.to_string()),crate::progenitor_support::encode_path(&document_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),);
...
&self,
account_id: &str, envelope_id: &str, include: &str,
) -> Result<crate::types::TemplateInformation> {
let mut query_args: Vec<(String, String)> = Default::default();
if !include.is_empty() { query_args.push(("include".to_string(), include.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/envelopes/{}/templates?{}",
...
&self,
account_id: &str, envelope_id: &str, preserve_template_recipient: &str,
body: &crate::types::DocumentTemplateList
) -> Result<crate::types::DocumentTemplateList> {
let mut query_args: Vec<(String, String)> = Default::default();
if !preserve_template_recipient.is_empty() { query_args.push(("preserve_template_recipient".to_string(), preserve_template_recipient.to_string())); }
