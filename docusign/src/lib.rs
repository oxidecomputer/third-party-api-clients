    ...
    
{
    ...
    let client_secret = env::var("DOCUSIGN_CLIENT_SECRET").expect("must set DOCUSIGN_CLIENT_SECRET");
    let redirect_uri = env::var("DOCUSIGN_REDIRECT_URI").expect("must set DOCUSIGN_REDIRECT_URI");
...
///
///For more information, see [Legal Disclosure](https://support.docusign.com/en/guides/ndse-admin-guide-legal-disclosure).
               pub fn account_consumer_disclosures(&self) -> account_consumer_disclosures::AccountConsumerDisclosures {
...
///
///For more information, see [Standards Based Signatures](https://developers.docusign.com/esign-rest-api/guides/standards-based-signatures).
               pub fn account_signature_providers(&self) -> account_signature_providers::AccountSignatureProviders {
...
///
///For more information, see [Legal Disclosure](https://support.docusign.com/en/guides/ndse-admin-guide-legal-disclosure).
               pub fn envelope_consumer_disclosures(&self) -> envelope_consumer_disclosures::EnvelopeConsumerDisclosures {
...
///You can also create your own custom account permission profiles.
///.
               pub fn account_permission_profiles(&self) -> account_permission_profiles::AccountPermissionProfiles {
...
/// The Envelope Document Visibility resource provides methods for managing document visibility by recipient.
///.
               pub fn envelope_document_visibility(&self) -> envelope_document_visibility::EnvelopeDocumentVisibility {
                    envelope_document_visibility::EnvelopeDocumentVisibility::new(self.clone())
               }

/// The Template Document Visibility resource provides methods for managing template document visibility by recipient.
///.
               pub fn template_document_visibility(&self) -> template_document_visibility::TemplateDocumentVisibility {
...
/// .
               pub fn envelope_document_html_definitions(&self) -> envelope_document_html_definitions::EnvelopeDocumentHtmlDefinitions {
                    envelope_document_html_definitions::EnvelopeDocumentHtmlDefinitions::new(self.clone())
               }

/// **Note**: Responsive Signing is disabled by default. To use this functionality, an account administrator must switch the account setting `enableResponsiveSigning` to **true**.
///Also note that Smart Sections (creating a signable HTML document that uses collapsible sections and rotating tables) are premium features. To request them, contact your DocuSign account manager.
               pub fn document_responsive_html_preview(&self) -> document_responsive_html_preview::DocumentResponsiveHtmlPreview {
...
/// **Note**: Responsive Signing is disabled by default. To use this functionality, an account administrator must switch the account setting `enableResponsiveSigning` to **true**.
///Also note that Smart Sections (creating a signable HTML document that uses collapsible sections and rotating tables) are premium features. To request them, contact your DocuSign account manager.
               pub fn template_document_responsive_html_preview(&self) -> template_document_responsive_html_preview::TemplateDocumentResponsiveHtmlPreview {
                    template_document_responsive_html_preview::TemplateDocumentResponsiveHtmlPreview::new(self.clone())
               }

/// **Note**: Responsive Signing is disabled by default. To use this functionality, an account administrator must switch the account setting `enableResponsiveSigning` to **true**.
///Also note that Smart Sections (creating a signable HTML document that uses collapsible sections and rotating tables) are premium features. To request them, contact your DocuSign account manager.
               pub fn template_responsive_html_preview(&self) -> template_responsive_html_preview::TemplateResponsiveHtmlPreview {
                    template_responsive_html_preview::TemplateResponsiveHtmlPreview::new(self.clone())
               }

/// .
               pub fn template_document_html_definitions(&self) -> template_document_html_definitions::TemplateDocumentHtmlDefinitions {
...
/// .
               pub fn envelope_workflow_definition(&self) -> envelope_workflow_definition::EnvelopeWorkflowDefinition {
