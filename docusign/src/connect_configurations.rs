...
if !list_included_users.is_empty() { query_args.push(format!("list_included_users={}", list_included_users)); }
...
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&connect_id.to_string()),query);
