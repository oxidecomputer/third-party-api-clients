...
&self,
account_id: &str, connect_id: &str,
) -> Result<crate::types::ConnectConfigResults> {
let url =
format!("/v2.1/accounts/{}/connect/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&connect_id.to_string()),);
...
&self,
account_id: &str, connect_id: &str, count: &str, email_substring: &str, list_included_users: &str, start_position: &str, status: &str, user_name_substring: &str,
...
if !list_included_users.is_empty() { query_args.push(("list_included_users".to_string(), list_included_users.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/connect/{}/users?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&connect_id.to_string()),query_);
