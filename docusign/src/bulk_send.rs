...
&self,
account_id: &str, batch_ids: &str, count: &str, start_position: &str, status: &str,
) -> Result<crate::types::BulkSendBatchSummaries> {
let mut query_args: Vec<(String, String)> = Default::default();
if !batch_ids.is_empty() { query_args.push(("batch_ids".to_string(), batch_ids.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/bulk_send_batch?{}",
...
&self,
account_id: &str, bulk_send_batch_id: &str,
) -> Result<crate::types::BulkSendBatchStatus> {
let url =
format!("/v2.1/accounts/{}/bulk_send_batch/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&bulk_send_batch_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/bulk_send_lists",
...
&self,
account_id: &str, bulk_send_list_id: &str,
) -> Result<crate::types::BulkSendingList> {
let url =
format!("/v2.1/accounts/{}/bulk_send_lists/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&bulk_send_list_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/bulk_send_lists/{}/send",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&bulk_send_list_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/bulk_send_lists/{}/test",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&bulk_send_list_id.to_string()),);
