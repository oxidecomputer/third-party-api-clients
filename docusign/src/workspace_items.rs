...
&self,
account_id: &str, folder_id: &str, workspace_id: &str, count: &str, include_files: &str, include_sub_folders: &str, include_thumbnails: &str, include_user_detail: &str, start_position: &str, workspace_user_id: &str,
) -> Result<crate::types::WorkspaceFolderContents> {
let mut query_args: Vec<(String, String)> = Default::default();
if !count.is_empty() { query_args.push(("count".to_string(), count.to_string())); }
if !include_files.is_empty() { query_args.push(("include_files".to_string(), include_files.to_string())); }
if !include_sub_folders.is_empty() { query_args.push(("include_sub_folders".to_string(), include_sub_folders.to_string())); }
if !include_thumbnails.is_empty() { query_args.push(("include_thumbnails".to_string(), include_thumbnails.to_string())); }
if !include_user_detail.is_empty() { query_args.push(("include_user_detail".to_string(), include_user_detail.to_string())); }
if !start_position.is_empty() { query_args.push(("start_position".to_string(), start_position.to_string())); }
if !workspace_user_id.is_empty() { query_args.push(("workspace_user_id".to_string(), workspace_user_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/workspaces/{}/folders/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&workspace_id.to_string()),crate::progenitor_support::encode_path(&folder_id.to_string()),query_);
...
&self,
account_id: &str, folder_id: &str, workspace_id: &str,
body: &crate::types::WorkspaceItemList
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/workspaces/{}/folders/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&workspace_id.to_string()),crate::progenitor_support::encode_path(&folder_id.to_string()),);
...
let url =
format!("/v2.1/accounts/{}/workspaces/{}/folders/{}/files",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&workspace_id.to_string()),crate::progenitor_support::encode_path(&folder_id.to_string()),);
...
&self,
account_id: &str, file_id: &str, folder_id: &str, workspace_id: &str, is_download: &str, pdf_version: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !is_download.is_empty() { query_args.push(("is_download".to_string(), is_download.to_string())); }
if !pdf_version.is_empty() { query_args.push(("pdf_version".to_string(), pdf_version.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/workspaces/{}/folders/{}/files/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&workspace_id.to_string()),crate::progenitor_support::encode_path(&folder_id.to_string()),crate::progenitor_support::encode_path(&file_id.to_string()),query_);
...
&self,
account_id: &str, file_id: &str, folder_id: &str, workspace_id: &str,
) -> Result<crate::types::WorkspaceItem> {
let url =
format!("/v2.1/accounts/{}/workspaces/{}/folders/{}/files/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&workspace_id.to_string()),crate::progenitor_support::encode_path(&folder_id.to_string()),crate::progenitor_support::encode_path(&file_id.to_string()),);
...
&self,
account_id: &str, file_id: &str, folder_id: &str, workspace_id: &str, count: &str, dpi: &str, max_height: &str, max_width: &str, start_position: &str,
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/workspaces/{}/folders/{}/files/{}/pages?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&workspace_id.to_string()),crate::progenitor_support::encode_path(&folder_id.to_string()),crate::progenitor_support::encode_path(&file_id.to_string()),query_);
