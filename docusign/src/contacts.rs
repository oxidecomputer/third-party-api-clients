...
pub async fn get(
&self,
account_id: &str, contact_id: &str, cloud_provider: &str,
) -> Result<crate::types::ContactGetResponse> {
let mut query_args: Vec<(String, String)> = Default::default();
if !cloud_provider.is_empty() { query_args.push(("cloud_provider".to_string(), cloud_provider.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/contacts/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&contact_id.to_string()),query_);
...
let url =
format!("/v2.1/accounts/{}/contacts/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&contact_id.to_string()),);
