...
if !cloud_provider.is_empty() { query_args.push(format!("cloud_provider={}", cloud_provider)); }
...
let url =
format!("/v2.1/accounts/{}/contacts/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&contact_id.to_string()),query);
