...
pub async fn get(
&self,
account_id: &str, group_type: &str, include_users: &str,
...
if !include_users.is_empty() { query_args.push(("include_users".to_string(), include_users.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/signing_groups?{}",
...
&self,
account_id: &str, signing_group_id: &str,
) -> Result<crate::types::SigningGroup> {
let url =
format!("/v2.1/accounts/{}/signing_groups/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&signing_group_id.to_string()),);
