...
if !stamp_format.is_empty() { query_args.push(("stamp_format".to_string(), stamp_format.to_string())); }
if !stamp_name.is_empty() { query_args.push(("stamp_name".to_string(), stamp_name.to_string())); }
...
let mut query_args: Vec<(String, String)> = Default::default();
if !decode_only.is_empty() { query_args.push(("decode_only".to_string(), decode_only.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/signatures?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
let url =
format!("/v2.1/accounts/{}/signatures/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),query_);
...
let url =
format!("/v2.1/accounts/{}/signatures/{}/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&signature_id.to_string()),crate::progenitor_support::encode_path(&image_type.to_string()),query_);
