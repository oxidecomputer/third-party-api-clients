...
&self,
account_id: &str, envelope_id: &str, documents_by_userid: &str, include_document_size: &str, include_metadata: &str, include_tabs: &str, recipient_id: &str, shared_user_id: &str,
) -> Result<crate::types::EnvelopeDocumentsResult> {
let mut query_args: Vec<(String, String)> = Default::default();
if !documents_by_userid.is_empty() { query_args.push(("documents_by_userid".to_string(), documents_by_userid.to_string())); }
if !include_document_size.is_empty() { query_args.push(("include_document_size".to_string(), include_document_size.to_string())); }
if !include_metadata.is_empty() { query_args.push(("include_metadata".to_string(), include_metadata.to_string())); }
if !include_tabs.is_empty() { query_args.push(("include_tabs".to_string(), include_tabs.to_string())); }
if !recipient_id.is_empty() { query_args.push(("recipient_id".to_string(), recipient_id.to_string())); }
if !shared_user_id.is_empty() { query_args.push(("shared_user_id".to_string(), shared_user_id.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/envelopes/{}/documents?{}",
...
&self,
account_id: &str, document_id: &str, envelope_id: &str, certificate: &str, documents_by_userid: &str, encoding: &str, encrypt: &str, language: &str, recipient_id: &str, shared_user_id: &str, show_changes: &str, watermark: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
if !certificate.is_empty() { query_args.push(("certificate".to_string(), certificate.to_string())); }
if !documents_by_userid.is_empty() { query_args.push(("documents_by_userid".to_string(), documents_by_userid.to_string())); }
if !encoding.is_empty() { query_args.push(("encoding".to_string(), encoding.to_string())); }
if !encrypt.is_empty() { query_args.push(("encrypt".to_string(), encrypt.to_string())); }
if !language.is_empty() { query_args.push(("language".to_string(), language.to_string())); }
if !recipient_id.is_empty() { query_args.push(("recipient_id".to_string(), recipient_id.to_string())); }
if !shared_user_id.is_empty() { query_args.push(("shared_user_id".to_string(), shared_user_id.to_string())); }
if !show_changes.is_empty() { query_args.push(("show_changes".to_string(), show_changes.to_string())); }
if !watermark.is_empty() { query_args.push(("watermark".to_string(), watermark.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/envelopes/{}/documents/{}?{}",
