...
&self,
account_id: &str, key_id: &str,
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/connect/secret/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&key_id.to_string()),);
