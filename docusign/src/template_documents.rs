...
&self,
account_id: &str, template_id: &str, include_tabs: &str,
...
let url =
format!("/v2.1/accounts/{}/templates/{}/documents?{}",
...
&self,
account_id: &str, document_id: &str, template_id: &str, encrypt: &str, show_changes: &str,
) -> Result<()> {
let mut query_args: Vec<(String, String)> = Default::default();
...
&self,
account_id: &str, document_id: &str, template_id: &str, is_envelope_definition: &str,
body: &crate::types::EnvelopeDefinition
) -> Result<crate::types::EnvelopeDocument> {
let mut query_args: Vec<(String, String)> = Default::default();
if !is_envelope_definition.is_empty() { query_args.push(("is_envelope_definition".to_string(), is_envelope_definition.to_string())); }
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/templates/{}/documents/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),crate::progenitor_support::encode_path(&document_id.to_string()),query_);
