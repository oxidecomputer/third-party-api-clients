...
let url =
format!("/v2.1/accounts/{}/connect/envelopes/retry_queue",
...
let url =
format!("/v2.1/accounts/{}/connect/failures?{}",
...
&self,
account_id: &str, failure_id: &str,
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/connect/failures/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&failure_id.to_string()),);
...
let query_ = serde_urlencoded::to_string(&query_args).unwrap();
let url =
format!("/v2.1/accounts/{}/connect/logs?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),query_);
...
&self,
account_id: &str, log_id: &str, additional_info: &str,
...
let url =
format!("/v2.1/accounts/{}/connect/logs/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&log_id.to_string()),query_);
...
&self,
account_id: &str, log_id: &str,
) -> Result<()> {
let url =
format!("/v2.1/accounts/{}/connect/logs/{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&log_id.to_string()),);
