...
if !apply_to_templates.is_empty() { query_args.push(format!("apply_to_templates={}", apply_to_templates)); }
...
let url =
format!("/v2.1/accounts/{}/custom_fields/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&custom_field_id.to_string()),query);
