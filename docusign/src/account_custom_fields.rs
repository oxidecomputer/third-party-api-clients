...
let url =
format!("/v2.1/accounts/{}/custom_fields",
...
pub async fn post(
&self,
account_id: &str, apply_to_templates: &str,
body: &crate::types::CustomField
) -> Result<crate::types::AccountCustomFields> {
let mut query_args: Vec<(String, String)> = Default::default();
if !apply_to_templates.is_empty() { query_args.push(("apply_to_templates".to_string(), apply_to_templates.to_string())); }
...
pub async fn put(
&self,
account_id: &str, custom_field_id: &str, apply_to_templates: &str,
body: &crate::types::CustomField
) -> Result<crate::types::AccountCustomFields> {
let mut query_args: Vec<(String, String)> = Default::default();
if !apply_to_templates.is_empty() { query_args.push(("apply_to_templates".to_string(), apply_to_templates.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/custom_fields/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&custom_field_id.to_string()),query_);
