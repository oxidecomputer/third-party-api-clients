...
if !created_from_date.is_empty() { query_args.push(("created_from_date".to_string(), created_from_date.to_string())); }
if !created_to_date.is_empty() { query_args.push(("created_to_date".to_string(), created_to_date.to_string())); }
...
if !is_deleted_template_only.is_empty() { query_args.push(("is_deleted_template_only".to_string(), is_deleted_template_only.to_string())); }
if !is_download.is_empty() { query_args.push(("is_download".to_string(), is_download.to_string())); }
if !modified_from_date.is_empty() { query_args.push(("modified_from_date".to_string(), modified_from_date.to_string())); }
if !modified_to_date.is_empty() { query_args.push(("modified_to_date".to_string(), modified_to_date.to_string())); }
...
if !search_fields.is_empty() { query_args.push(("search_fields".to_string(), search_fields.to_string())); }
if !search_text.is_empty() { query_args.push(("search_text".to_string(), search_text.to_string())); }
if !shared_by_me.is_empty() { query_args.push(("shared_by_me".to_string(), shared_by_me.to_string())); }
if !start_position.is_empty() { query_args.push(("start_position".to_string(), start_position.to_string())); }
if !template_ids.is_empty() { query_args.push(("template_ids".to_string(), template_ids.to_string())); }
if !to_date.is_empty() { query_args.push(("to_date".to_string(), to_date.to_string())); }
if !used_from_date.is_empty() { query_args.push(("used_from_date".to_string(), used_from_date.to_string())); }
if !used_to_date.is_empty() { query_args.push(("used_to_date".to_string(), used_to_date.to_string())); }
...
let url =
format!("/v2.1/accounts/{}/templates/{}?{}",
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),query_);
...
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),crate::progenitor_support::encode_path(&document_id.to_string()),query_);
...
self.client.delete(&url, Some(reqwest::Body::from(serde_json::to_vec(body)?))).await
}
...
crate::progenitor_support::encode_path(&account_id.to_string()),crate::progenitor_support::encode_path(&template_id.to_string()),crate::progenitor_support::encode_path(&document_id.to_string()),crate::progenitor_support::encode_path(&page_number.to_string()),query_);
