...
let url =
format!("/v1/companies/{}/earning_types",
...
* Update an earning type.
*/
pub async fn put_company_s_type(
&self,
company_id: &str, earning_type_uuid: &str,
body: &crate::types::PutV1CompaniesCompanyIdEarningTypesTypeUuidRequest
) -> Result<crate::types::EarningType> {
let url =
format!("/v1/companies/{}/earning_types/{}",
crate::progenitor_support::encode_path(&company_id.to_string()),crate::progenitor_support::encode_path(&earning_type_uuid.to_string()),);
...
* Deactivate an earning type.
*/
pub async fn delete_company_s_type(
&self,
company_id: &str, earning_type_uuid: &str,
) -> Result<()> {
let url =
