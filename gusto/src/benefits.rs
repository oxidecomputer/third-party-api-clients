...
*/
pub async fn get_v_1_benefits(
&self,
) -> Result<Vec<crate::types::SupportedBenefit>> {
let url =
"/v1/benefits".to_string();
...
* The benefit object in Gusto contains high level information about a particular benefit type and its tax considerations. When companies choose to offer a benefit, they are creating a Company Benefit object associated with a particular benefit.
*/
pub async fn get_v_1_benefits_benefit_id(
&self,
...
let url =
format!("/v1/companies/{}/company_benefits",
...
let url =
format!("/v1/employees/{}/employee_benefits",
...
let url =
format!("/v1/employees/{}/ytd_benefit_amounts_from_different_company",
crate::progenitor_support::encode_path(&employee_id.to_string()),);
...
* Employee benefits represent an employee enrolled in a particular company benefit. It includes information specific to that employee’s enrollment.
*/
pub async fn delete_v_1_employee_benefits_employee_benefit_id(
&self,
) -> Result<()> {
let url =
format!("/v1/employee_benefits/{}",
