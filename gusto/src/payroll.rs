...
&self,
processed: bool, include_off_cycle: bool, include: &[String], start_date: &str, end_date: &str,
...
&self,
include: crate::types::GetV1CompaniesCompanyIdPayrollsInclude, show_calculation: &str,
) -> Result<crate::types::PayrollData> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
...
*/
pub async fn put_v_1_companies_company_id_payrolls_payroll_id_calculate(
&self,
) -> Result<()> {
let url =
...
*/
pub async fn put_v_1_companies_company_id_payrolls_payroll_id_submit(
&self,
) -> Result<()> {
let url =
