...
&self,
company_id_or_uuid: &str, start_date: &str, end_date: &str,
...
let url =
format!("/v1/companies/{}/pay_periods?{}",
crate::progenitor_support::encode_path(&company_id_or_uuid.to_string()),query);
...
*/
pub async fn get_company_s(
&self,
company_id_or_uuid: &str, processed: bool, include_off_cycle: bool, include: &[String], start_date: &str, end_date: &str,
) -> Result<Vec<crate::types::PayrollData>> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
if !end_date.is_empty() { query_args.push(format!("end_date={}", end_date)); }
if !include.is_empty() { query_args.push(format!("include={}", include.join(" "))); }
if include_off_cycle { query_args.push(format!("include_off_cycle={}", include_off_cycle)); }
if processed { query_args.push(format!("processed={}", processed)); }
if !start_date.is_empty() { query_args.push(format!("start_date={}", start_date)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
...
* This function performs a `GET` to the `/v1/companies/{company_id_or_uuid}/payrolls` endpoint.
*
* As opposed to `get_company_s`, this function returns all the pages of the request at once.
*
* Returns all payrolls, current and past for a company.
* 
* Notes:
...
* * Every eligible compensation is returned for each employee. If no data has yet be inserted for a given field, it defaults to “0.00” (for fixed amounts) or “0.000” (for hours ).
*/
pub async fn get_all_company_s(
&self,
company_id_or_uuid: &str, processed: bool, include_off_cycle: bool, include: &[String], start_date: &str, end_date: &str,
) -> Result<Vec<crate::types::PayrollData>> {
let mut query = String::new();
...
*/
pub async fn get_company_(
&self,
company_id_or_uuid: &str, payroll_id_or_uuid: &str, include: crate::types::GetV1CompaniesCompanyIdPayrollsInclude, show_calculation: &str,
) -> Result<crate::types::PayrollData> {
let mut query = String::new();
let mut query_args: Vec<String> = Default::default();
query_args.push(format!("include={}", include));
if !show_calculation.is_empty() { query_args.push(format!("show_calculation={}", show_calculation)); }
for (i, n) in query_args.iter().enumerate() {
                    if i > 0 {
                        query.push('&');
                    }
...
let url =
format!("/v1/companies/{}/payrolls/{}?{}",
crate::progenitor_support::encode_path(&company_id_or_uuid.to_string()),crate::progenitor_support::encode_path(&payroll_id_or_uuid.to_string()),query);
...
*/
pub async fn put_company_s(
&self,
company_id_or_uuid: &str, payroll_id_or_uuid: &str,
body: &crate::types::PutV1CompaniesCompanyIdPayrollsRequest
) -> Result<crate::types::PayrollData> {
let url =
format!("/v1/companies/{}/payrolls/{}",
crate::progenitor_support::encode_path(&company_id_or_uuid.to_string()),crate::progenitor_support::encode_path(&payroll_id_or_uuid.to_string()),);
...
*/
pub async fn put_company_s_pay_period_start_date_end(
&self,
company_id_or_uuid: &str, pay_period_start_date: &str, pay_period_end_date: &str,
body: &crate::types::PutV1CompaniesCompanyIdPayrollsRequest
) -> Result<crate::types::PayrollData> {
let url =
format!("/v1/companies/{}/payrolls/{}/{}",
crate::progenitor_support::encode_path(&company_id_or_uuid.to_string()),crate::progenitor_support::encode_path(&pay_period_start_date.to_string()),crate::progenitor_support::encode_path(&pay_period_end_date.to_string()),);
...
*/
pub async fn put_company_s_calculate(
&self,
company_id: &str, payroll_id: &str,
) -> Result<()> {
let url =
format!("/v1/companies/{}/payrolls/{}/calculate",
crate::progenitor_support::encode_path(&company_id.to_string()),crate::progenitor_support::encode_path(&payroll_id.to_string()),);
...
*/
pub async fn put_company_s_submit(
&self,
company_id: &str, payroll_id: &str,
) -> Result<()> {
let url =
format!("/v1/companies/{}/payrolls/{}/submit",
crate::progenitor_support::encode_path(&company_id.to_string()),crate::progenitor_support::encode_path(&payroll_id.to_string()),);
...
* 
*/
pub async fn put_api_company_s_cancel(
&self,
company_id: &str, payroll_id: &str,
) -> Result<crate::types::PayrollData> {
let url =
format!("/v1/companies/{}/payrolls/{}/cancel",
crate::progenitor_support::encode_path(&company_id.to_string()),crate::progenitor_support::encode_path(&payroll_id.to_string()),);
...
let url =
format!("/v1/companies/{}/payroll_reversals",
crate::progenitor_support::encode_path(&company_id_or_uuid.to_string()),);
